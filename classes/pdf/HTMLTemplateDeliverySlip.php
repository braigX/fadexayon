...
class HTMLTemplateDeliverySlipCore extends HTMLTemplate
{
    ...
    public function getContent()
    {
        ...
        $state = isset($delivery_address->id_state) ? new State((int) $delivery_address->id_state) : null;
        $customer = new Customer((int) $delivery_address->id_customer);
        ...
        $formatted_delivery_address .= $state ? $state->name . '<br/>' : '';
