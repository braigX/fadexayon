...
class ProductCore extends ObjectModel
{
    ...
    public $weight = 0;
    /** @var string|float Volume in default volume unit */
    public $volume = 0; 
    ...
    public static $definition = [
        ...
        'fields' => [
            ...
            'volume' => ['type' => self::TYPE_FLOAT, 'validate' => 'isUnsignedFloat'],//volume
     ...
     * @param float $volume Additional volume
     ...
     * @param float $price Additional price
     * @param float $weight Additional weight
     * param float $volume Additional volume//volume
    ...
    public function addAttribute(
       ...
       // $combination->volume = (float) $volume;//volume
    ...
    public static function getProductName($id_product, $id_product_attribute = null, $id_lang = null)
    {
        ...
        // added by Braigue
        $product_name = Db::getInstance()->getValue($query);
        $product_name = str_replace((string)$id_product, '', $product_name);
