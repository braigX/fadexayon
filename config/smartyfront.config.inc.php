...
if (Module::isEnabled('jprestaspeedpack')) {
	...
	smartyRegisterFunction($smarty, 'block', 'widget_block', array('Jprestaspeedpack', 'smartyWidgetBlockPageCache'));
	$smarty->registerFilter('pre', array('Jprestaspeedpack', 'smartyWidgetBlockPageCachePrefilter'));
} else {
