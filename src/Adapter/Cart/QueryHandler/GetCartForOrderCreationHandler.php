...
final class GetCartForOrderCreationHandler extends AbstractCartHandler implements GetCartForOrderCreationHandlerInterface
{
    ...
    private function buildCartProduct(
        ...
        return new CartProduct(
            ...
            isset($product['width']) ? (float) $product['width'] : null,
            isset($product['height']) ? (float) $product['height'] : null,
            isset($product['depth']) ? (float) $product['depth'] : null,
            isset($product['weight']) ? (float) $product['weight'] : null
        );
    }
}
