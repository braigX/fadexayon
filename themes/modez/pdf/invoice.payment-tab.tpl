...
<table id="payment-tab" width="100%">
  <tr>
    <td class="payment center small grey bold" width="44%">
      {if $order->id_lang == 1}Mode de paiement
      {elseif $order->id_lang == 2}Betaalmethode
      {elseif $order->id_lang == 3}Zahlungsmethode
      {elseif $order->id_lang == 4}Método de pago
      {elseif $order->id_lang == 5}Metodo di pagamento
      {else}Payment Method
      {/if}
    </td>
    <td class="payment left white" width="56%">
      <table width="100%" border="0">
          ...
          <tr>
            <td class="right small">
              ...
              {elseif $order->id_lang == 5} {* 🇮🇹 Italian *}
                ...
                {elseif $method == 'Paiement par carte bancaria'}Pagamento con carta bancaria
        ...
        {foreachelse}
          <tr>
            <td colspan="2">
              {if $order->id_lang == 1}Pas de paiement
              {elseif $order->id_lang == 2}Geen betaling
              {elseif $order->id_lang == 3}Keine Zahlung
              {elseif $order->id_lang == 4}Sin pago
              {elseif $order->id_lang == 5}Nessun pagamento
              {else}No payment
              {/if}
            </td>
          </tr>
