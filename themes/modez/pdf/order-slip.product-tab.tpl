...
<table class="product" width="100%" cellpadding="4" cellspacing="0">
    ...
    <thead>
        <tr>
            <th class="product header small" width="60%">
                {if $order->id_lang == 1}Produit / Référence
                {elseif $order->id_lang == 2}Product / Referentie
                {elseif $order->id_lang == 3}Produkt / Referenz
                {elseif $order->id_lang == 4}Producto / Referencia
                {elseif $order->id_lang == 5}Prodotto / Riferimento
                {else}Produit / Référence
                {/if}
            </th>
            <th class="product header small" width="10%">
                ...
                {elseif $order->id_lang == 4}Cant.
                {elseif $order->id_lang == 5}Qtà
                {else}Qté
                {/if}
            </th>
            <th class="product header-right small" width="15%">
                ...
                {if $tax_excluded_display}
                    {if $order->id_lang == 1}(HT)
                    {elseif $order->id_lang == 2}(excl. BTW)
                    {elseif $order->id_lang == 3}(ohne MwSt.)
                    {elseif $order->id_lang == 4}(sin IVA)
                    {elseif $order->id_lang == 5}(al netto IVA)
                    {else}(HT)
                    {/if}
                {else}
                    {if $order->id_lang == 1}(TTC)
                    {elseif $order->id_lang == 2}(incl. BTW)
                    {elseif $order->id_lang == 3}(inkl. MwSt.)
                    {elseif $order->id_lang == 4}(con IVA)
                    {elseif $order->id_lang == 5}(IVA inclusa)
                    {else}(TTC)
                    {/if}
                {/if}
            </th>
            <th class="product header-right small" width="15%">
                {if $order->id_lang == 1}Prix total
                {elseif $order->id_lang == 2}Prijs
                {elseif $order->id_lang == 3}Gesamtpreis
                {elseif $order->id_lang == 4}Precio
                {elseif $order->id_lang == 5}Prezzo totale
                {else}Prix total
                {/if}
                <br />
                {if $tax_excluded_display}
        ...
        {if !isset($order_details) || count($order_details) == 0}
            <tr class="product" colspan="4">
                <td class="product center">
                    {if $order->id_lang == 1}Pas de détails
                    {elseif $order->id_lang == 2}Geen details
                    {elseif $order->id_lang == 3}Keine Details
                    {elseif $order->id_lang == 4}Sin detalles
                    {elseif $order->id_lang == 5}Nessun dettaglio
                    {else}Pas de détails
                    {/if}
                </td>
            </tr>
