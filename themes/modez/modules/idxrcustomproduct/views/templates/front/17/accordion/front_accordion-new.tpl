...
<section class="page-product-box row" id="idxr_customisation_section">
            ...
            <div class="braig_addtocart_section">
                <div id="submit_idxrcustomproduct_unique_12345" class="cart-container-unique-12345">
                    <div class="quantity-controls-unique-12345">
                        <input type="number" id="quantity_unique_12345" value="1">
                        <div class="qty-buttons-unique-12345">
                            <button class="qty-change-unique-12345 increase">+</button>
                            <button class="qty-change-unique-12345 decrease">-</button>
                        </div>
                    </div>
	...
	<script>
		window.onload = function() {
        	document.getElementById('preloader-overlay-xyz123').style.display = 'none';
			document.getElementById('spinner-abc456').style.display = 'none';
    	};
	</script>
</section>