...
<section class="page-product-box row" id="idxr_customisation_section">
    ...
    <div id="idxr-addtocart-error-modal" class="idxr-inline-modal" aria-hidden="true">
        ...
        <div class="idxr-inline-modal__dialog" role="dialog" aria-modal="true" aria-labelledby="idxr-addtocart-error-title">
            ...
            <div id="idxr-addtocart-error-title" class="h3 idxr-inline-modal__title">{l s='Une erreur est survenue' mod='idxrcustomproduct'}</div>
    ...
    <div id="idxr-save-success-modal" class="idxr-inline-modal" aria-hidden="true">
        <div class="idxr-inline-modal__backdrop" data-idxr-close-save-success-modal="1"></div>
        <div class="idxr-inline-modal__dialog idxr-inline-modal__dialog--success" role="dialog" aria-modal="true" aria-labelledby="idxr-save-success-title">
            <div class="idxr-inline-modal__icon idxr-inline-modal__icon--success">
                <i class="material-icons">check_circle</i>
            </div>
            <div id="idxr-save-success-title" class="idxr-inline-modal__title h3">{l s='Personnalisation enregistrée' mod='idxrcustomproduct'}</div>
            <p id="idxr-save-success-message" class="idxr-inline-modal__message">{l s='Votre personnalisation a bien été enregistrée. Vous pourrez la retrouver plus tard depuis vos simulations enregistrées.' mod='idxrcustomproduct'}</p>
            <div class="idxr-inline-modal__actions">
                <button type="button" class="idxr-inline-modal__button idxr-inline-modal__button--success" data-idxr-close-save-success-modal="1">{l s='Fermer' mod='idxrcustomproduct'}</button>
            </div>
        </div>
    </div>
    <style>
        ...
        .idxr-inline-modal__icon--success {
            background: #edf9f0;
            color: #2d8a49;
        }
        .idxr-inline-modal__dialog--success {
            border-top: 4px solid #2d8a49;
        }
        ...
        .idxr-inline-modal__button--success {
            background: #2d8a49;
        }
