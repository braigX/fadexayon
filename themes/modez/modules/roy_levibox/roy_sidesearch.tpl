    ...
    <ul>
        ...
        <li class="search_prod tip_inside">
            <a href="{$product.url|escape:'html':'UTF-8'}" title="">
                <img src="{if $product.cover}{$product.cover.bySize.medium_default.url}?format=webp{/if}" alt="{if !empty($product.cover.legend)}{$product.cover.legend}{else}{$product.name|truncate:30:'...'}{/if}" data-full-size-image-url="{if $product.cover}{$product.cover.bySize.large_default.url}{/if}"width="100%" height="auto">
