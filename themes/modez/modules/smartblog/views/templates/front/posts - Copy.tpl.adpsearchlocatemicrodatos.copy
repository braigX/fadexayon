		...
		<div id="content" class="block">
			<div   id="sdsblogArticle" class="blog-post">
				...
				<div class="sdsarticleHeader">
					<span>
						{if $smartshowauthor ==1} {l s='Posted by ' mod='smartblog'}
			...
			<ul class="footer_links clearfix">
				{foreach from=$posts_previous item="post"}
        			{if isset($post.id_smart_blog_post)}
						<li>
							<a title="{l s='Previous Post' mod='smartblog'}" href="{$smartbloglink->getSmartBlogPostLink($post.id_smart_blog_post,$post.link_rewrite)|escape:'htmlall':'UTF-8'}" class="btn btn-default button button-small"><span> {l s='Previous Post' mod='smartblog'}</span></a>
						</li>
					{/if}
				{/foreach}
				{foreach from=$posts_next item="post"}
					{if isset($post.id_smart_blog_post)}
						<li class="pull-right">
							<a title="{l s='Next Post' mod='smartblog'}" href="{$smartbloglink->getSmartBlogPostLink($post.id_smart_blog_post,$post.link_rewrite)|escape:'htmlall':'UTF-8'}" class="btn btn-default button button-small"><span>{l s='Next Post' mod='smartblog'}  </span></a>
						</li>
					{/if}
				{/foreach}
			</ul>
