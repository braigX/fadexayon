                    ...
                    <div id="sds_blog_post" class="col-xs-12 col-sm-4 col-md-3">
                        <span class="news_module_image_holder">
                            ...
                            {if $smartbloglink->getImageLink($post.link_rewrite, $post.id, 'home-default') != 'false'}
                                <img class="replace-2x img-responsive" src="{$smartbloglink->getImageLink($post.link_rewrite, $post.id, 'home-default')}" alt="{$post.title|escape:'html':'UTF-8'}" title="{$post.title|escape:'html':'UTF-8'}"    />
                            {/if}
                            </a>
                        </span>
