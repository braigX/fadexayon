 ...
 *}
<div id="personnalisation" class="page-product">
{if isset($products[0])}
     ...
     <div class="row">
      ...
      <div class="price-information topblock">
       ...
       {block name='product_without_taxes'}
          <div class="product-without-taxes">{l s='%price% / m² HT' d='Shop.Theme.Catalog' sprintf=['%price%' => $product.price_tax_exc|number_format:2]}</div>
       {/block}
     </div>
...
{else}
  <p>{l s='No product found' d='Shop.Theme.Catalog'}</p>
{/if}
