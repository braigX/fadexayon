          ...
          <div class="col-md-7">
            <div class="cart-content">
              ...
              {if !$configuration.display_prices_tax_incl && $configuration.taxes_enabled}
                <p><strong>{$cart.totals.total.label}&nbsp;{$cart.labels.tax_short}</strong>&nbsp;<span>{$cart.totals.total.value}</span></p>
                <p class="product-total"><span class="label"><strong>{$cart.totals.total_including_tax.label}</strong></span>&nbsp;<span class="value">{$cart.totals.total_including_tax.value}</span></p>
              {else}
                <p class="product-total"><span class="label"><strong>{$cart.totals.total.label}&nbsp;{if $configuration.taxes_enabled}{$cart.labels.tax_short}{/if}</strong></span>&nbsp;<span class="value">{$cart.totals.total.value}</span></p>
              {/if}
