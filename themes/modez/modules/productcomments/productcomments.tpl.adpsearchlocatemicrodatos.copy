                        ...
                        <div class="comment clearfix"   >
                            <div class="comment_author">
                                <div class="star_content clearfix"   >
                                    ...
                                    {/section}
                                    <meta  content = "0" />
                                    <meta  content = "{$comment.grade}" />
                                    <meta  content = "5" />
                                </div>
                                <div class="comment_author_infos">
                                    <strong >{$comment.customer_name|escape:'html':'UTF-8'}</strong><br/>
                                    <em>{dateFormat date=$comment.date_add|escape:'html':'UTF-8' full=0}</em>
                                    <meta  content="{dateFormat date=$comment.date_add|escape:'html':'UTF-8' full=0}" />
                                </div>
                            </div>
                    ...
                    {if isset($productcomments_product) && $productcomments_product}
                        <div class="product clearfix">
                            <div class="product_desc">
                                <h4 class="product_name">{if isset($productcomments_product->name)}{$productcomments_product->name}{elseif isset($productcomments_product.name)}{$productcomments_product.name}{/if}</h4>
