...
*}
{if $isDropdown}
	<div class="blog-categories hidden-sm-down sidebar-block">
		<div class="sidebar-content">
			<h4 class="text-uppercase h6 hidden-sm-down sidebar-inner-title"><a href="{smartblog::GetSmartBlogLink('smartblog')}">{l s='Category' mod='smartblogpopularposts'}</a></h4>
			<select onchange="document.location.href=this.options[this.selectedIndex].value;" class="form-control form-control-select">
...
{else}
	...
	<div class="blog-categories hidden-sm-down sidebar-block">
		<h4 class="text-uppercase h6 hidden-sm-down sidebar-title"><a href="{smartblog::GetSmartBlogLink('smartblog')}">{l s='Category' mod='smartblogpopularposts'}</a></h4>
		<div class="sidebar-content">
