	...
	<div id="step_title_{$step.id_component|intval}" class="panel-collapse collapse" role="tabpanel">
	    ...
	    {include file="../../partials/component_description.tpl"}
	        <div class="input-group">
	            <input type="number" class="form-control accordion_text" id="text_{$step.id_component|intval}" placeholder="{*l s='Insert text' mod='idxrcustomproduct'*}" value=""/>
                    <span class="input-group-btn">
                        <button class="btn btn-success js-text-next-btn" id="js-text-next-btn-{$step.id_component|intval}" type="button"><i class="material-icons">save</i>Enregistrer</button>
                    </span>
	        </div>
	    </div><!-- card-body -->
