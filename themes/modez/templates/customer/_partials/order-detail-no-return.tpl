...
{block name='order_products_table'}
    ...
    <table id="order-products" class="table table-bordered">
      ...
      <tfoot>
        {foreach $order.subtotals as $line}
          {if $line.value}
            {if $line.type == 'shipping'}{hook h="displayPaymentRuleOrderDetailNoReturn" order=$order.details}{/if}<tr class="text-xs-right line-{$line.type}">
  ...
  <div class="order-totals hidden-md-up box">
    {foreach $order.subtotals as $line}
      {if $line.value}
        {if $line.type == 'shipping'}{hook h="displayPaymentRuleOrderDetailNoReturn2" order=$order.details}{/if}<div class="order-total row">
