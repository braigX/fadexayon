...
<div id="recent_article_smart_blog_block_left"  class="block sidebar-block blogModule boxPlain">
  <div class="sidebar-content">
     <h4 class="text-uppercase h6 hidden-sm-down sidebar-inner-title"><a href="{smartblog::GetSmartBlogLink('smartblog')}">{l s='Recent Articles' mod='smartblogrecentposts'}</a></h4>
