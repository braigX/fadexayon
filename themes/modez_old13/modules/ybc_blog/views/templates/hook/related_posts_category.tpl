...
{if $posts}
    <div data-items="{$blog_config.YBC_BLOG_RELATED_CATEGORY_ROW|intval}" class="block ybc_block_related_category_page ybc_block_related {$blog_config.YBC_BLOG_RTL_CLASS|escape:'html':'UTF-8'} {if isset($blog_page) && $blog_page}page_{$blog_page|escape:'html':'UTF-8'}{else}page_blog{/if} {if isset($blog_config.YBC_BLOG_CATEGORY_POST_TYPE) && $blog_config.YBC_BLOG_CATEGORY_POST_TYPE=='default' || count($posts)<=1} ybc_block_default{else} ybc_block_slider{/if}">
        <h2 class="h2 title_blog title_block">{l s='Related posts' mod='ybc_blog'}</h2>
        {assign var='product_row' value=$blog_config.YBC_BLOG_RELATED_CATEGORY_ROW|intval}
        <div class="ybc_blog_content_block{if count($posts)>1 && $blog_config.YBC_BLOG_CATEGORY_POST_TYPE!='default'} blog_type_slider{/if}">
                            ...
                            <div class="ybc-blog-latest-toolbar">                                         
                                ...
                                {if $allowComments && $post.comments_num >0}
                                    <span class="ybc-blog-latest-toolbar-comments"><i class="ets_svg"><svg width="14" height="14" viewBox="0 0 1792 1792" xmlns="http://www.w3.org/2000/svg"><path d="M896 384q-204 0-381.5 69.5t-282 187.5-104.5 255q0 112 71.5 213.5t201.5 175.5l87 50-27 96q-24 91-70 172 152-63 275-171l43-38 57 6q69 8 130 8 204 0 381.5-69.5t282-187.5 104.5-255-104.5-255-282-187.5-381.5-69.5zm896 512q0 174-120 321.5t-326 233-450 85.5q-70 0-145-8-198 175-460 242-49 14-114 22h-5q-15 0-27-10.5t-16-27.5v-1q-3-4-.5-12t2-10 4.5-9.5l6-9 7-8.5 8-9q7-8 31-34.5t34.5-38 31-39.5 32.5-51 27-59 26-76q-157-89-247.5-220t-90.5-281q0-174 120-321.5t326-233 450-85.5 450 85.5 326 233 120 321.5z"/></svg>
                                        ...
                                        {if $post.comments_num!=1}{l s='comments' mod='ybc_blog'}
                                        {else}{l s='comment' mod='ybc_blog'}{/if}</span>
                                {/if}
                                {if $allow_like}
