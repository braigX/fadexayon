...
$(document).ready(function() {
    ...
    // Remove price and attributes from product page
	  ...
	  const allowedProductIds = [];// [15897, 496];
    ...
    parentdiv.on('click', '#idxrcustomproduct_send', function(event){
        ...
        $('.overlay').addClass('relaod-custum');
        reloadPageProduit();
    });
    ...
    function reloadPageProduit() {
        // Sélectionnez l'élément avec la classe .relaod-custum
        var closeButtons = document.querySelectorAll('.relaod-custum');     
        if (closeButtons) {
          // Ajoutez un gestionnaire d'événements à chaque élément .relaod-custum
          closeButtons.forEach(function (button) {
            button.addEventListener('click', function () {
              // Vérifiez si l'élément avec l'ID #product existe
