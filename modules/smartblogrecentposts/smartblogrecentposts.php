...
class SmartBlogRecentPosts extends Module
{
    ...
    public function __construct()
    {
        ...
        $this->displayName = $this->trans('Smart Blog Recent Posts', [], 'Modules.Smartblogrecentposts.Smartblogrecentposts');
        $this->description = $this->trans('The Most Powerfull Presta shop Blog  Module\'s tag - by smartdatasoft', [], 'Modules.Smartblogrecentposts.Smartblogrecentposts');
        $this->confirmUninstall = $this->trans('Are you sure you want to delete your details ?', [], 'Modules.Smartblogrecentposts.Smartblogrecentposts');
    }
    ...
    public function getContent()
    {
        ...
        if (Tools::isSubmit('save' . $this->name)) {
            ...
            $html = $this->displayConfirmation($this->trans('The settings have been updated successfully.', [], 'Modules.Smartblogrecentposts.Smartblogrecentposts'));
            ...
            if (Module::isInstalled(trim('smartblog'))) {
                ...
                if (!Module::isEnabled(trim('smartblog'))) {
                    return $this->displayError($this->trans('This Is A Child Module of SmartBlog. Please Enable SmartBlog to Use This Module', [], 'Modules.Smartblogrecentposts.Smartblogrecentposts'));
                }
            } else {
                return $this->displayError($this->trans('This Is A Child Module of SmartBlog. Please Install SmartBlog to Use This Module', [], 'Modules.Smartblogrecentposts.Smartblogrecentposts'));
            }
    ...
    public function SettingForm()
    {
        ...
        $this->fields_form[0]['form'] = array(
            'legend' => array(
                'title' => $this->trans('General Setting', [], 'Modules.Smartblogrecentposts.Smartblogrecentposts'),
            ),
            'input' => array(

                array(
                    'type' => 'text',
                    'label' => $this->trans('Show Number Of Recent Posts', [], 'Modules.Smartblogrecentposts.Smartblogrecentposts'),
            ...
            'submit' => array(
                'title' => $this->trans('Save', [], 'Modules.Smartblogrecentposts.Smartblogrecentposts'),
            )
        );
        ...
        $helper->toolbar_btn = array(
            'save' =>
            array(
                'desc' => $this->trans('Save', [], 'Modules.Smartblogrecentposts.Smartblogrecentposts'),
