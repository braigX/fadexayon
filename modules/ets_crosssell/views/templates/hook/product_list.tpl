...
{else}
    {if $page_name !='index' && $page_name !='product' && $page_name != 'order-confirmation' && $page_name!='orderconfirmation' && $page_name!='cms' && $page_name!='contact'}
...
{if isset($sort_options) && $sort_options && isset($products) && $products}
    <form class="ets_sortby_form" action="" method="post">
        ...
        <select name="ets_crosssell_sort_by" data-page="{$name_page|escape:'html':'UTF-8'}" data-tab="{$tab|escape:'html':'UTF-8'}" id="ets_crosssell_sort_by_{$name_page|escape:'html':'UTF-8'}_{$tab|escape:'html':'UTF-8'}" class="ets_crosssel_sort_by">
            <option value="">--</option>
