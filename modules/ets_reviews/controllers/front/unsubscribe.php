...
class Ets_reviewsUnsubscribeModuleFrontController extends ModuleFrontController
{
    ...
    public function initContent()
    {
        ...
        } elseif (EtsRVTools::encrypt($email) !== $verify) {
        ...
        if (!$this->_errors)
            $assigns['msg'] = $this->module->l('Unsubscribed successfully.', 'unsubscribe');
        else
    ...
    {
        if (!EtsRVUnsubscribe::setCustomerUnsubscribe($email)) {
            return false;
        }
        return true;
    }
