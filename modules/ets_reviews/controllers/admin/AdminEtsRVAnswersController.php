...
class AdminEtsRVAnswersController extends AdminEtsRVCommentsController
{
    public function __construct()
    {
        $this->qa = $this->answer = 1;
        parent::__construct();
    }
    ...
    public function initToolbarTitle()
    {
        ...
        $this->toolbar_title = $this->l('Answers', 'AdminEtsRVAnswersController');
    }
}