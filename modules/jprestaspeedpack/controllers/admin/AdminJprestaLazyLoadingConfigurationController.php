...
class AdminJprestaLazyLoadingConfigurationController extends ModuleAdminController
{
    ...
    public function __construct()
    {
        ...
        $this->jpresta_submodule = $this->module->jpresta_submodules['JprestaLazyLoading'];
    }
