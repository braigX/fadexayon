...
class PhOSCo_Sniffs_Functions_FunctionDeclarationSniff implements PHP_CodeSniffer_Sniff
{
    ...
    {
        return array(\T_FUNCTION, \JPresta\Greenlion\T_CLOSURE);
    }
    //end register()
    /**
    ...
    public function process(PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        ...
        if ($tokens[$stackPtr]['code'] === \JPresta\Greenlion\T_CLOSURE) {
        ...
        if ($tokens[$openBracket]['line'] === $tokens[$closeBracket]['line']) {
            ...
            if ($tokens[$stackPtr]['code'] === \JPresta\Greenlion\T_CLOSURE) {
                if ($use !== \false) {
                    ...
                    $open = $phpcsFile->findNext(\JPresta\Greenlion\T_OPEN_PARENTHESIS, $use + 1);
    ...
    {
        if (\class_exists('JPresta\\Greenlion\\Generic_Sniffs_Functions_OpeningFunctionBraceKernighanRitchieSniff', \true) === \false) {
    ...
    public function processMultiLineDeclaration(PHP_CodeSniffer_File $phpcsFile, $stackPtr, $tokens)
    {
        ...
        if (isset($tokens[$stackPtr]['scope_opener']) === \true) {
            ...
            if ($next !== \false && $tokens[$next]['code'] !== \JPresta\Greenlion\T_OPEN_CURLY_BRACKET) {
