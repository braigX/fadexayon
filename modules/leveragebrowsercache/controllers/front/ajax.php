...
class leveragebrowsercacheajaxModuleFrontController extends ModuleFrontController
{
	public $ssl = true;
	...
	public function initContent()
	{
		...
		if (Tools::getIsset('action'))
		{
			...
			if (method_exists('leveragebrowsercacheajaxModuleFrontController', $function_name))
				$this->$function_name();
		}
