...
class leveragebrowsercacheproductsModuleFrontController extends ModuleFrontController
{
	public $ssl = true;
		...
		if($results)
		{
			foreach($results as $res)
			{
				...
				foreach($langs as $lang)
				{
					...
					echo 'Cached -> '.$url.'<br/>';		
					leveragebrowsercache::get_url_content_static($url);
					
					if((int)Configuration::get('rc_products_preview_p') == 1)
						leveragebrowsercache::get_url_content_static($url.'?content_only=1');
				}		
			}
