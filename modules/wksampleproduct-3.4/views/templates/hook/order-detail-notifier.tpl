...
<div class="panel mb-2">
    <div class="box" style="overflow: auto;">
        <div class="{if isset($isHummingBirdThemeEnable) && $isHummingBirdThemeEnable}h3{else}h5{/if}"
            style='display: flex; align-items: center;'>
            <i class="icon-money"></i>
            {l s='Sample products' mod='wksampleproduct'}
            ...
            <tbody>
                {foreach $sample as $product}
                    <tr>
                        ...
                        <td><span
                                class="product_quantity_show badge">{$product.product_quantity|escape:'htmlall':'UTF-8'}</span>
                        </td>
