...
class Roy_New_Products extends Widget_Base
{
	...
	{
		return PrestaHelper::__('Roy New Products', 'elementor');
	}
	...
	protected function render()
	{
		...
		$context->smarty->assign(
			array(
				...
				'elementprefix'       => 'newproducts',
				'theme_template_path' => _PS_THEME_DIR_ . 'templates/catalog/_partials/miniatures/product.tpl',
                'allProductsLink' => Context::getContext()->link->getPageLink('new-products'),
			)
		);
...
CrazyElements\Plugin::instance()->widgets_manager->register_widget_type(new \Roy_New_Products());
