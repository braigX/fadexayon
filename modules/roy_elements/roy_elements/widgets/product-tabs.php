...
?>
        ...
        <ul class='nav nav-tabs nav-tabs--carusel title-align-<?php echo $title_align; ?> <?php if ( $layout == 'slider' ) : ?>slider-on<? endif; ?>' data-auto='<?php echo $is_autoplay; ?>' data-max-slides='<?php echo $per_row; ?>' role='tablist'>
            <?php
            if (!empty($settings['items'])) {
                $i = 0;
                foreach ($settings['items'] as $tab) {
