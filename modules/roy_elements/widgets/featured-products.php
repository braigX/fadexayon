...
class Roy_Featured_Products extends Widget_Base
{
	...
	{
		return PrestaHelper::__('Roy Featured Products', 'elementor');
	}
	...
	protected function render()
	{
		...
		$cache_products = $category->getProducts((int) $context->language->id, $page, $per_page, $orderby, $order, false, true, (bool) $random, $randomNumberProducts = $per_page);
		if (!$cache_products) {
...
CrazyElements\Plugin::instance()->widgets_manager->register_widget_type(new \Roy_Featured_Products());
