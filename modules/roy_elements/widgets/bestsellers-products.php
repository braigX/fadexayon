...
class Roy_BestSellers_Products extends Widget_Base
{
	...
	{
		return 'roy_bestsellers_products';
	}
	...
	{
		return PrestaHelper::__('Roy Best Sellers Products', 'elementor');
	}
	...
	protected function _register_controls()
	{
		...
		$this->add_control(
			...
			array(
				...
				'type'    => Controls_Manager::SELECT,
				'options' => array(
					'sales'    => PrestaHelper::__( 'Sales', 'elementor' ),
	...
	protected function render()
	{
		...
		$context->smarty->assign(
			array(
				...
				'elementprefix'       => 'bestsellers',
				'theme_template_path' => _PS_THEME_DIR_ . 'templates/catalog/_partials/miniatures/product.tpl',
                'allProductsLink' => Context::getContext()->link->getPageLink('best-sales'),
			)
		);
...
CrazyElements\Plugin::instance()->widgets_manager->register_widget_type(new \Roy_Bestsellers_Products());
