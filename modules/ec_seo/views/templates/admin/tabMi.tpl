 {if !$refresh}<div id="table_mi_{$type|escape:'htmlall':'UTF-8'}" class="panel table_mi_info" data-type="{$type|escape:'htmlall':'UTF-8'}">{/if}
    <div class="panel-heading">
        <span class="panel-heading-action">
            <a class="list-toolbar-btn" href="#" onclick="Ec_search_gcplus('{$type|escape:'htmlall':'UTF-8'}', 'mi')">
    ...
    <tr id="search_mi">
        ...
        <td></td>
        {* <td><input value="{if isset($searchs['np_replace'])}{$searchs['np_replace']}{/if}" class="conf" name="np_replace" type="text" style="width:100px"/></td> *}
    </tr>
    ...
    <div class="bottom-mi">
        ...
        <ul class="pagination pull-right">
            <li {if $pageActif == 1}class="disabled"{/if}>
                <a href="javascript:void(0);" class="pagination-link" onclick="Ec_rep_pagination(1, '{$type|escape:'htmlall':'UTF-8'}', 'mi')" data-list-id="product">
                    <i class="icon-double-angle-left"></i>
                </a>
            </li>
            <li {if $pageActif-1 == 0}class="disabled"{/if}>
                <a href="#" class="pagination-link" data-page="0" data-list-id="product" {if $pageActif-1 != 0}onclick="Ec_rep_pagination({$pageActif-1|escape:'htmlall':'UTF-8'}, '{$type|escape:'htmlall':'UTF-8'}', 'mi')"{/if}>
                ...
                {for $page=1 to $nbpage}
                    ...
                    <li {if $pageActif == $page}class="active"{/if}>
                        <a href="" class="pagination-link"  data-list-id="product" onclick="Ec_rep_pagination({$page|escape:'htmlall':'UTF-8'}, '{$type|escape:'htmlall':'UTF-8'}', 'mi')">{$page|escape:'htmlall':'UTF-8'}</a>
                    </li>
                    {else if $cpt == 3}
                        <li class="disabled">
                            <a href="" class="pagination-link" data-page="..." data-list-id="product">...</a>
            ...
            <li {if $pageActif+1 > $nbpage}class="disabled"{/if}>
                <a href="javascript:void(0);" class="pagination-link" data-page="{$pageActif+1|escape:'htmlall':'UTF-8'}" {if $pageActif+1 <= $nbpage}onclick="Ec_rep_pagination({$pageActif+1|escape:'htmlall':'UTF-8'}, '{$type|escape:'htmlall':'UTF-8'}','mi')"{/if} data-list-id="product">
                    <i class="icon-angle-right"></i>
                </a>
            </li>
            <li {if $pageActif == $nbpage || $countInfo == 0}class="disabled"{/if}>
                <a href="javascript:void(0);" class="pagination-link" onclick="Ec_rep_pagination({$nbpage|escape:'htmlall':'UTF-8'}, '{$type|escape:'htmlall':'UTF-8'}', 'mi')" data-list-id="product">
