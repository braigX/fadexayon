...
<div class="small_panel panel active" id="regenerate_manufacturers"  >
    <div class="panel-heading"><i class="icon-minus"></i> {l s='Compress theme images' mod='ultimateimagetool'}</div>
    ...
    <table class="table">
	    ...
	    <tbody id="samdha_warper" rel="theme">
	    	...
	    	<tr>
	    		...
	    		<td>
		    		<select id="image_quality_theme" class="image_quality" name="image_quality_theme" rel="theme" style="width:70px;">
	    	...
	    	<tr>
	    		<td>
	    			<button class="button btn btn-primary get_theme_images" rel="{$uit_tpl_dir|escape:'htmlall':'UTF-8'}">{l s='Search current theme for images' mod='ultimateimagetool'}</button>
	    		</td>
	    		<td colspan="3">
	    	...
	    	<tr>
	    		<td colspan="4" id="uit_theme_result">
