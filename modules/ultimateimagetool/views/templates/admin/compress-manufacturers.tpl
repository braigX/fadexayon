...
<div class="small_panel panel active" id="regenerate_manufacturers"  >
    <div class="panel-heading"><i class="icon-minus"></i> {l s='Compress manufacturer images' mod='ultimateimagetool'}</div>
    <div>
    	{l s='In the table bellow, you will see the number of manufacturers not images, it will compress all of the images of each manufacturer.' mod='ultimateimagetool'}
    </div>    
    ...
    <table class="table">
	    ...
	    <tbody id="samdha_warper">
	    	...
	    	<tr>
	    		...
	    		<td>
		    		<select id="image_quality_cat" name="image_quality_cat" rel="manufacturer">
	    	...
	    	<tr class="manuf_type_original">
	    		...
	    		<td>
	    			...
	    			<button class="UltimateImageTool_manufacturerplay"><span class="ui-button-icon-primary ui-icon ui-icon-play"></span></button>
	    			<button class="UltimateImageTool_manufacturerstop"><span class="ui-button-icon-primary ui-icon ui-icon-stop"></span></button>
	    			<button class="UltimateImageTool_manufacturerreset"><span class="ui-button-icon-primary ui-icon ui-icon-refresh"></span></button>
				</td>
	    		<td>
	    			<div class="progress ui-progressbar ui-widget ui-widget-content ui-corner-all" ><div class="text"> <span class="category_current">{$original_offset_manuf|escape:'htmlall':'UTF-8'}</span> {l s='of' mod='ultimateimagetool'} <span id="categories_max">{$manufacturer_count|escape:'htmlall':'UTF-8'}</span></div><div class="{$manufacturer_count|escape:'htmlall':'UTF-8'}_progress  ui-progressbar-value ui-widget-header ui-corner-left" style="width: {$original_percent_manuf|escape:'htmlall':'UTF-8'}%;"></div></div>
	    		</td>
	    		<td  class="saved_after">{$original_saved_space_manuf|escape:'htmlall':'UTF-8'} {l s='Kb' mod='ultimateimagetool'}</td>
	    		
	    	</tr>

	    	{foreach from=$manufacturer_sizes item=reg_item}
	    	<tr class="manuf_type_{$reg_item.name|escape:'htmlall':'UTF-8'}">
