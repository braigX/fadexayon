...
*}
<div class="small_panel panel active" id="convert_manufacturers"  >
    <div class="panel-heading"><i class="icon-minus"></i> {l s='Convert module images' mod='ultimateimagetool'}</div>
    <table class="table">
	    <thead class="">
	    	<tr class="first">
	    ...
	    <tbody id="samdha_warper" rel="module">
	    	...
	    	<tr>
	    		...
	    		<td>
		    		<select id="image_quality_module" name="image_quality_module" class="image_quality" rel="module" style="width:70px;">
	    	...
	    	<tr>
	    		<td>
	    			<button class="button btn btn-primary get_module_images_webp" rel="{$uit_module_dir|escape:'htmlall':'UTF-8'}">{l s='Search current modules for images' mod='ultimateimagetool'}</button>
	    		</td>
	    		<td colspan="3">
	    	...
	    	<tr>
	    		<td colspan="4" id="uit_module_result_webp">
