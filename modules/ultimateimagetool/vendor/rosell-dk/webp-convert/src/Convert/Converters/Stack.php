...
//        $this->logLn('converters: ' . print_r($converters, true));
        ...
        if ($anyRuntimeErrors) {
             ...
             return array('error' => 1,'error_msg' => 'None of the converters in the stack could convert the image.');
            // At least one converter failed
            throw new ConversionFailedException(
                'None of the converters in the stack could convert the image.'
            );
        } else {
            return array('error' => 1,'error_msg' => 'None of the converters in the stack are operational');
