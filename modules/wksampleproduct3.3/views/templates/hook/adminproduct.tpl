                    ...
                    <div class="form-group">
                        ...
                        <div class="translatable-field lang-{$lang.id_lang} row" {if $lang.id_lang
                            ...
                            <div class="col-lg-8">
                                ...
                                <small class="form-text text-muted"><em>{l s='Default label name \'Buy Sample\', applied if empty and maximum ' mod='wksampleproduct'} {$WK_SAMPLE_BUTTON_TITLE_ALLOWED_CHARACTERS|escape:'htmlall':'UTF-8'} {l s=' characters are allowed.' mod='wksampleproduct'}</em></small>
                            </div>
                            <div class="col-lg-3">
