...
class TNTOfficiel_FPDF_TPL extends TNTOfficiel_FPDF
{
    ...
    public function beginTemplate($x = null, $y = null, $w = null, $h = null)
    {
        if (is_subclass_of($this, 'TNTOfficiel_TCPDF')) {
            throw new LogicException('This method is only usable with TNTOfficiel_FPDF. Use TNTOfficiel_TCPDF methods startTemplate() instead.');
        }
     ...
     *
     * @return int|bool If a template is opened, the id is returned. If not a false is returned.
     */
    public function endTemplate()
    {
        if (is_subclass_of($this, 'TNTOfficiel_TCPDF')) {
            $args = func_get_args();
            return call_user_func_array(array($this, 'TNTOfficiel_TCPDF::endTemplate'), $args);
        }
    ...
    public function setFont($family, $style = '', $size = null, $fontfile = '', $subset = 'default', $out = true)
    {
        if (is_subclass_of($this, 'TNTOfficiel_TCPDF')) {
            $args = func_get_args();
            return call_user_func_array(array($this, 'TNTOfficiel_TCPDF::SetFont'), $args);
        }
    ...
    public function Image(
        ...
        if (is_subclass_of($this, 'TNTOfficiel_TCPDF')) {
            $args = func_get_args();
            return call_user_func_array(array($this, 'TNTOfficiel_TCPDF::Image'), $args);
        }
    ...
    public function AddPage($orientation = '', $format = '', $keepmargins = false, $tocpage = false)
    {
        if (is_subclass_of($this, 'TNTOfficiel_TCPDF')) {
            $args = func_get_args();
            return call_user_func_array(array($this, 'TNTOfficiel_TCPDF::AddPage'), $args);
        }
    ...
    public function Link($x, $y, $w, $h, $link, $spaces = 0)
    {
        if (is_subclass_of($this, 'TNTOfficiel_TCPDF')) {
            $args = func_get_args();
            return call_user_func_array(array($this, 'TNTOfficiel_TCPDF::Link'), $args);
        }
    ...
    public function AddLink()
    {
        if (is_subclass_of($this, 'TNTOfficiel_TCPDF')) {
            $args = func_get_args();
            return call_user_func_array(array($this, 'TNTOfficiel_TCPDF::AddLink'), $args);
        }
    ...
    public function SetLink($link, $y = 0, $page = -1)
    {
        if (is_subclass_of($this, 'TNTOfficiel_TCPDF')) {
            $args = func_get_args();
            return call_user_func_array(array($this, 'TNTOfficiel_TCPDF::SetLink'), $args);
        }
