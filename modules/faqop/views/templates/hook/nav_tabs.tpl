...
<div class="faq-nav-row">
    <ul class="faq-nav-tabs">
        ...
        <li class="faq-nav-tab {if $active_url === 'position'}faq-nav-tab-active{/if}">
            <a href="{$position_url|escape:'html':'UTF-8'}" class="faq-nav-link">
                <i class="fas fa-map-pin"></i>&nbsp;{l s='Hook Settings' mod='faqop'}</a>
        </li>
