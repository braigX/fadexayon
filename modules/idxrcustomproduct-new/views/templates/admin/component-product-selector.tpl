...
<div class="panel">
    <div class="panel-heading">
        ...
        </svg> {l s='Select Attribute for edit' mod='idxrcustomproduct'}
    </div>
    <div class="panel-body">
        {foreach from=$subcomponents item=subcomponent}
            <a href="{$backurl}{$subcomponent.id_component}&token={$token}">{$subcomponent.name}</a><br/>
        {/foreach}
