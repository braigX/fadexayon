...
class AdminCrazyfbuilderController extends ModuleAdminController {
	...
	public function renderList() {
		...
		$this->_where = 'AND a.`hook` = "fbuilder"';

		$link      = new Link();
		$settingslink  = PrestaHelper::get_setting_page_url();
		$setting_link = '<a class="btn btn-primary" href="'.$settingslink.'#configuration_form_6">Set Footer Template</a>';
