...
abstract class Controls_Stack extends Base_Object {
	...
	/**
	 * @since  1.0.0
	 * @since  1.0.0 Added the `controls` and the `settings` parameters.
	 * @access public
	 *
	...
	public function add_control( $id, array $args, $options = array() ) {
		...
		if ( empty( $args['type'] ) || ! in_array( $args['type'], array( Controls_Manager::SECTION, Controls_Manager::WP_WIDGET ), true ) ) {
			...
			} elseif ( empty( $args['section'] ) && ( ! $options['overwrite'] || PrestaHelper::is_wp_error( Plugin::$instance->controls_manager->get_control_from_stack( $this->get_unique_name(), $id ) ) ) ) {
	...
	final public function get_position_info( array $position ) {
		...
		if ( 'control' === $position['type'] && in_array( $position['at'], array( 'start', 'end' ), true )
	 ...
	 *
	 * @since  1.0.0
	 * @since  1.0.0 Added the `settings` parameter.
	 * @access public
	 *
	...
	final public function get_tabs_controls() {
		...
		// echo '<pre>',print_r($this->get_stack());
	...
	public function get_settings_for_display( $setting_key = null ) {
		...
		$controls_arr = $this->get_controls();
	...
	public function start_controls_section( $section_id, array $args = array() ) {
		 ...
		 */
		PrestaHelper::do_action( 'elementor/element/before_section_start', $this, $section_id, $args );
		 ...
		 * @param array          $args Section arguments.
		 */
		PrestaHelper::do_action( "elementor/element/{$section_name}/{$section_id}/before_section_start", $this, $args );
		 ...
		 * @param array          $args       Section arguments.
		 */
		PrestaHelper::do_action( 'elementor/element/after_section_start', $this, $section_id, $args );
		 ...
		 * @param array          $args Section arguments.
		 */
		PrestaHelper::do_action( "elementor/element/{$section_name}/{$section_id}/after_section_start", $this, $args );
	}
	...
	public function end_controls_section() {
		 ...
		 * @param array          $args       Section arguments.
		 */
		PrestaHelper::do_action( 'elementor/element/before_section_end', $this, $section_id, $args );
		 ...
		 * @param array          $args Section arguments.
		 */
		PrestaHelper::do_action( "elementor/element/{$stack_name}/{$section_id}/before_section_end", $this, $args );
		 ...
		 * @param array          $args       Section arguments.
		 */
		PrestaHelper::do_action( 'elementor/element/after_section_end', $this, $section_id, $args );
		 ...
		 * @param array          $args Section arguments.
		 */
		PrestaHelper::do_action( "elementor/element/{$stack_name}/{$section_id}/after_section_end", $this, $args );
	}
	...
	public function print_template() {
		 ...
		 */
		$template_content = PrestaHelper::apply_filters( "elementor/{$element_type}/print_template", $template_content, $this );

		if ( empty( $template_content ) ) {
			return;
		}
		?>
		<script type="text/html" id="tmpl-elementor-<?php echo PrestaHelper::esc_attr( $this->get_name() ); ?>-content">
