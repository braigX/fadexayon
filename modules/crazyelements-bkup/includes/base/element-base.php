...
abstract class Element_Base extends Controls_Stack {
	...
	final public function enqueue_scripts() {
		foreach ( $this->get_script_depends() as $script ) {
			PrestaHelper::wp_enqueue_script( $script );
		}
	}
	...
	final public function enqueue_styles() {
		foreach ( $this->get_style_depends() as $style ) {
			PrestaHelper::wp_enqueue_style( 'extra',$style );
		}
	}
	...
	final public static function is_edit_buttons_enabled() {
		return PrestaHelper::get_option( 'elementor_edit_buttons' );
	}
	...
	public function get_help_url() {
		return "";
		return 'https://classydevs.com/docs/crazy-elements/' . $this->get_name();
	}
	...
	public function get_render_attribute_string( $element ) {
		...
		//print_r($this->render_attributes[ $element ]);
	...
	public function add_link_attributes( $element, array $url_control, $overwrite = false ) {
		...
		if ( ! empty( $url_control['url'] ) ) {
			$allowed_protocols = array_merge( PrestaHelper::get_allowed_protocols(), [ 'skype', 'viber' ] );

			$attributes['href'] = PrestaHelper::esc_url( $url_control['url'], $allowed_protocols );
		}
	...
	public function render_autocomplete_result( $ids ) {
	...
	public function print_element() {
		 ...
		 */
		PrestaHelper::do_action( 'elementor/frontend/before_render', $this );
		 ...
		 * @param Element_Base $this The element.
		 */
		PrestaHelper::do_action( "elementor/frontend/{$element_type}/before_render", $this );
		 ...
		 * @param Element_Base $this The element.
		 */
		$should_render = PrestaHelper::apply_filters( "elementor/frontend/{$element_type}/should_render", $should_render, $this );
		if ( $should_render ) {
		 ...
		 * @param Element_Base $this The element.
		 */
		PrestaHelper::do_action( "elementor/frontend/{$element_type}/after_render", $this );
		 ...
		 * @param Element_Base $this The element.
		 */
		PrestaHelper::do_action( 'elementor/frontend/after_render', $this );
	}
	...
	protected function _add_render_attributes() {
		 ...
		 * @param Element_Base $this The element.
		 */
		PrestaHelper::do_action( 'elementor/element/after_add_attributes', $this );
	}
	...
	private function get_child_type( $element_data ) {
		 ...
		 */
		$child_type = PrestaHelper::apply_filters( 'elementor/element/get_child_type', $child_type, $element_data, $this );
