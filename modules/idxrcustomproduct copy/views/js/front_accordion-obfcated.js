  ...
  const t = (() => {
        ...
        (function () {
          ...
          function P(t = 0, e = 0) {
            ...
            function h(t, e, o, n, r) {
              if (1 === t && 1 === e) {
                const t = o,
                  e = o - r;
                return (
                  d.circle(t, e, n).attr(i), void Z(t, o - r, n, r, 0, o / 2)
                );
              }
              if (1 === t || 1 === e) {
                if (1 === t) {
            ...
            function g(t, e, o, n, r, c = 8) {
              ...
              var p = $([l, s], _, [0, s]),
                m = o;
              Math.abs(Math.sin(p / 2)) > Number.EPSILON &&
                (m = Math.abs(o / Math.sin(p / 2)));
              var x = $(_, [0, s], [l, s]),
                h = o,
                f = 8 === c ? x : x / 2;
              Math.abs(Math.sin(f)) > Number.EPSILON &&
                9 !== c &&
                (h = Math.abs(o / Math.sin(f)));
              var v = $(_, [l, s], [0, s]),
                g = o,
                k = 8 === c ? v : v / 2;
              Math.abs(Math.sin(k)) > Number.EPSILON &&
                10 !== c &&
                (g = Math.abs(o / Math.sin(k)));
              const b = m,
                w = h,
                y = s - o,
                P = l - g,
              ...
              if (1 === t && 1 === e) {
                const t = u,
                  e = b - r;
                return Z(t, e, n, r, 0, o), void d.circle(t, e, n).attr(i);
              }
              if (1 !== t)
                if (1 !== e) {
                  for (let t = 0; t < e; t++) {
          ...
          function C(t, e, o, n, a, i, r = 1, s = 0, l = 0) {
            const d = M(t),
              _ = M(e),
              u = M(o),
              p = M(n),
    ...
    function L() {
      ...
      $(".accordion_text").on("input", function () {
        ...
        $("#quantity_unique_12345").on("input change", function () {
          let e = parseInt($(this).val(), 10);
          (isNaN(e) || e < 1) && $(this).val(1), t();
        }),
        $(".qty-change-unique-12345.increase").on("click", function () {
          let e = parseInt($("#quantity_unique_12345").val());
          (e += 1), $("#quantity_unique_12345").val(e).trigger("change"), t();
        }),
        ...
        B(),
          (function () {
            ...
            [
              ...
              $(t.selector).on("click", function () {
                c(t.value),
                  "#card_5_8" === t.selector
                    ? $("#step_content_9 .card-header-h5 a")
                        .contents()
                        .filter(function () {
                          return 3 === this.nodeType;
                        })
                        .first()
                        .replaceWith("Longueur du côté")
                    : $("#step_content_9 .card-header-h5 a")
                        .contents()
                        .filter(function () {
                          return 3 === this.nodeType;
