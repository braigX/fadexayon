...
class Roy_Customizer extends Module
{
    ...
    public function install()
    {
        ...
        if (parent::install() and $this->registerHook('displayHeader') and $this->registerHook('displayAdminHomeQuickLinks') and $this->registerHook('displayBackOfficeHeader') and $this->registerHook('displaySideSearch') and $this->registerHook('hookActionProductSearchAfter')) {
    ...
    public function displayForm()
    {
                ...
                <div class="roytc_content">
                  ...
                  <div class="hr"></div>
                     ...
                     <div class="roytc_row ds_wrap" style="margin-bottom:100px;">
                        <label>' . $this->l('Body layout') . '</label>
                  ...
                  <div class="hr"></div>
                    ...
                    <div class="roytc_row" style="margin-top:0;">
                        ...
                        <div class="roytc_row">
                              <label>' . $this->l('Bottom margin') . '</label>
                              <div class="margin-form">
        ...
        $html .= '
            ...
            <h4>Controls</h4>
                  ...
                  <div class="roytc_row">
                     <label>' . $this->l('Color hover') . '</label>
                        <div class="margin-form">
            ...
            <div class="half">
                ...
                <div class="roytc_row">
                    <label>' . $this->l('Account title') . '</label>
                        <div class="margin-form">
        ...
        $html .= '
          ...
          <div class="tab-content hide" id="tab-global5">
                ...
                <div class="half half_right">
                      <div class="roytc_row">
                        <label>' . $this->l('Normal button hover background') . '</label>
                        <div class="margin-form">
                      ...
                      <div class="roytc_row">
                        <label>' . $this->l('Normal button hover border') . '</label>
                        <div class="margin-form">
                      ...
                      <div class="roytc_row">
                        <label>' . $this->l('Normal button hover color') . '</label>
                        <div class="margin-form">
          ...
          <div class="tab-content hide" id="tab-global6">
               <h3 class="first">' . $this->l('Inputs') . '</h3>
                ...
                <div class="half half_right">
                  <div class="roytc_row">
                    <label style="line-height:18px">' . $this->l('Checkboxes, radio checked background') . '</label>
                    <div class="margin-form">
        ...
        $html .= '
                  ...
                  <div class="roytc_row ds_wrap">
                        <label>' . $this->l('Menu elements align') . '</label>
                        <div class="margin-form" style="margin-top:0; padding-top:10px;">
              ...
              <div class="half" style="width:620px; padding-bottom:0;">
                <div class="roytc_row">
                    <label>' . $this->l('Underline on hover?') . '</label>
                    <div class="margin-form">
                  ...
                  <div class="roytc_row">
                        <label>' . $this->l('Underline on hover color') . '</label>
                        <div class="margin-form">
              ...
              <div class="half" style="width:620px; padding-bottom:0;">
                  ...
                  <div class="roytc_row">
                        <label>' . $this->l('Link background hover') . '</label>
                        <div class="margin-form">
            ...
            <div class="tab-pane" id ="tab-side">
                ...
                <div class="half" style="width:620px; padding-bottom:0;">
                        ...
                        <div class="roytc_row">
                              <label>' . $this->l('Cart product inside') . '</label>
                              <div class="margin-form">
                ...
                <div class="half" style="width:620px; padding-bottom:0;">
                        ...
                        <div class="roytc_row">
                              <label>' . $this->l('Comment / light text') . '</label>
                              <div class="margin-form">
                  ...
                  <div class="tab-content hide" id="tab-side2">
                      ...
                      <div class="roytc_row ds_wrap">
                            ...
                            <div class="margin-form" style="margin-top:0; padding-top:10px;">
                                ...
                                <label class="ds hemo3" for="nc_hemo3"> <span>3 . Menu Bottom sticky</span></label>
                      </div></div>
        ...
        $html .= '
                        ...
                        <div class="roytc_row">
                              <label>' . $this->l('Header Menu icon') . '</label>
                              <div class="margin-form">
            ...
            <div class="tab-content hide" id="tab-fonts1">
                 <h3 class="first">' . $this->l('Font family') . '</h3>
                    <div class="roytc_row">
		        		<label>' . $this->l('Headings and menu font') . '</label>
                                <div class="margin-form">
                              ';
        ...
        $html .= '
                                ...
                                <label>' . $this->l('Product names in category') . '</label>
                                <div class="margin-form">
                                ';
      ...
      <div class="tab-content hide" id="tab-fonts2">
            ...
            <div class="half">
                    ...
                    <div class="roytc_row">
                        <label>' . $this->l('Headings and titles') . '</label>
                        <div class="margin-form">
                    ...
                    <div class="roytc_row">
                        <label>' . $this->l('Product name in category') . '</label>
                        <div class="margin-form">
            ...
            <div class="half half_right">
                    ...
                    <div class="roytc_row">
                        <label>' . $this->l('Product page price') . '</label>
                        <div class="margin-form">
                    ...
                    <div class="roytc_row">
                        <label>' . $this->l('Product page title') . '</label>
                        <div class="margin-form">
      ...
      <div class="tab-content hide" id="tab-fonts3">
            ...
            <div class="half" style="width:680px;">
                     ...
                     <div class="roytc_row">
                        <label>' . $this->l('Homepage product blocks titles') . '</label>
                        <div class="margin-form" style="margin-top:70px; padding-top:10px;">
                     ...
                     <div class="roytc_row">
                        <label>' . $this->l('Footer titles') . '</label>
                        <div class="margin-form" style="margin-top:70px; padding-top:10px;">
                     ...
                     <div class="roytc_row">
                        <label>' . $this->l('Blog post titles') . '</label>
                        <div class="margin-form" style="margin-top:70px; padding-top:10px;">
            ...
            <div class="half half_right" style="width:620px">
                     <div class="roytc_row">
                        <label style="width:220px">' . $this->l('Buttons') . '</label>
                     ...
                     <div class="roytc_row">
                        <label style="width:220px">' . $this->l('Product names in category') . '</label>
                     ...
                     <div class="roytc_row">
                        <label style="width:220px">' . $this->l('Product name on product page') . '</label>
                        <div class="margin-form" style="margin-top:70px; padding-top:10px; padding-left: 230px!important">
                     ...
                     <div class="roytc_row">
                        <label style="width:220px">' . $this->l('Info tabs on product page') . '</label>
                        <div class="margin-form" style="margin-top:70px; padding-top:10px; padding-left: 230px!important">
      ...
      <div class="tab-content hide" id="tab-fonts4">
            ...
            <div class="half" style="padding-bottom:0">
                  ...
                  <div class="roytc_row font_weight">
                        <label>' . $this->l('Menu elements') . '</label>
                        <div class="margin-form">
            ...
            <div class="half half_right" style="padding-bottom:0">
                  <div class="roytc_row font_weight">
                        <label>' . $this->l('Normal text') . '</label>
                        <div class="margin-form">
      ...
      <div class="tab-content hide" id="tab-fonts5">
            ...
            <div class="half" style="padding-bottom:0;">
                     <div class="roytc_row">
                        <label>' . $this->l('Italic style for product names?') . '</label>
                        <div class="margin-form" style="margin-top:0; padding-top:10px;">
            ...
            <div class="half half_right" style="padding-bottom:0;">
            <div class="roytc_row">
               <label>' . $this->l('Italic style for product price?') . '</label>
               <div class="margin-form" style="margin-top:0; padding-top:10px;">
            ...
            <div class="half" style="padding-bottom:0;">
                  <div class="roytc_row">
                        <label>' . $this->l('Body letter-spacing') . '</label>
                        <div class="margin-form">
                              <input type="text" name="nc_ls"  value="' . Configuration::get('NC_LS') . '" />px
                        </div>
                  </div>
                  <div class="roytc_row">
                        <label>' . $this->l('Headings letter-spacing') . '</label>
                        <div class="margin-form">
            ...
            <div class="half half_right" style="padding-bottom:0;">
                  <div class="roytc_row">
                        <label>' . $this->l('Titles letter-spacing') . '</label>
                        <div class="margin-form">
                              <input type="text" name="nc_ls_t"  value="' . Configuration::get('NC_LS_T') . '" />px
                        </div>
                  </div>
                  <div class="roytc_row">
                        <label>' . $this->l('Buttons letter-spacing') . '</label>
                        <div class="margin-form">
        ...
        <div class="roytc_row ds_wrap">
            ...
            <div class="tab-pane" id="tab-page">
                  ...
                  <div class="roytc_row ds_wrap">
                          <label>' . $this->l('Breadcrumb align') . '</label>
                          <div class="margin-form" style="margin-top:0; padding-top:10px;">
            ...
            <div class="tab-pane" id="tab-sidebar">
                ...
                <div class="tab-content hide" id="tab-sidebar1">
                  <h3 class="first">' . $this->l('Blocks titles') . '</h3>
                        <div class="roytc_row">
                              <label>' . $this->l('Enable background for blocks titles?') . '</label>
                              <div class="margin-form">
                  ...
                  <div class="hr"></div>
                        ...
                        <div class="roytc_row" style="margin-top:0;">
                              <label>' . $this->l('Enable content border?') . '</label>
                              <div class="margin-form" style="margin-top:0;">
                  ...
                  <div class="if_sidebar_content_b">
                     ...
                     <div class="half" style="width:620px; padding-bottom:0;">
                        <div class="roytc_row">
                             <label>' . $this->l('Block content text color') . '</label>
                             <div class="margin-form">
                        ...
                        <div class="roytc_row">
                             <label>' . $this->l('Block content separators') . '</label>
                             <div class="margin-form">
                        ...
                        <div class="hr"></div>
                        <div class="roytc_row">
                             <label>' . $this->l('Filter titles') . '</label>
                             <div class="margin-form">
                ...
                <div class="tab-content hide" id="tab-sidebar2">
                      <h3 class="first">' . $this->l('Sidebar blocks with products') . '</h3>
                        <div class="roytc_row">
                             <label>' . $this->l('Sidebar product price') . '</label>
                             <div class="margin-form">
                        ...
                        <div class="roytc_row">
                             <label>' . $this->l('Sidebar product old price') . '</label>
                             <div class="margin-form">
                     ...
                     <div class="half_container very_low_paddings" style="display:inline-block; width:100%">
                        ...
                        <div class="roytc_row">
                             <label>' . $this->l('Button background hover') . '</label>
                             <div class="margin-form">
                        ...
                        <div class="roytc_row">
                             <label>' . $this->l('Button border hover') . '</label>
                             <div class="margin-form">
                        ...
                        <div class="roytc_row">
                             <label>' . $this->l('Button color hover') . '</label>
                             <div class="margin-form">
            ...
            <div class="tab-pane" id ="tab-productlist">
                ...
                <div class="tab-content hide" id="tab-productlist1">
                    ...
                    <div class="margin-form">
                        ...
                        <h3>' . $this->l('Category page content') . '</h3>
                            ...
                            <div class="roytc_row">
                                 <label>' . $this->l('Grid/list icon color') . '</label>
                                 <div class="margin-form">
                ...
                <div class="tab-content hide" id="tab-productlist2">
                  ...
                  <div class="half_container low_paddings" style="display:inline-block; width:100%">
                     <div class="half">
                        <div class="roytc_row">
                             <label>' . $this->l('Item border') . '</label>
                             <div class="margin-form">
                      ...
                      <div class="roytc_row">
                           <label>' . $this->l('Item border hover') . '</label>
                           <div class="margin-form">
                  ...
                  <div class="half">
                      ...
                      <div class="hr"></div>
                        <div class="roytc_row" style="margin-top:0;">
                              <label>' . $this->l('Display shadow on hover?') . '</label>
                              <div class="margin-form" style="margin-top:0;">
                    ...
                    <h3>' . $this->l('Quick view and Discover') . '</h3>
                      ...
                      <div class="roytc_row">
                        ...
                        <div class="roytc_row ds_wrap">
                              <label>' . $this->l('Quick view icon') . '</label>
                              <div class="margin-form" style="margin-top:0; padding-top:10px;">
                    ...
                    <div class="hr"></div>
                        ...
                        <div class="roytc_row">
                              <label>' . $this->l('Enable Color Swatches if product has colors?') . '</label>
                              <div class="margin-form">
            ...
            <div class="tab-pane" id ="tab-productpage">
                ...
                <div class="tab-content hide" id="tab-productpage1">
                  ...
                  <h3 class="first">' . $this->l('Image column design') . '</h3>
                    <div class="half_container low_paddings" style="display:inline-block; width:100%">
                      ...
                      <div class="roytc_row">
                        <label>' . $this->l('How much thumbs visible?') . '</label>
                        <div class="margin-form">
                  ...
                  <div class="hr"></div>
                        ...
                        <div class="roytc_row ds_wrap">
                              <label>' . $this->l('Image zoom icon') . '</label>
                              <div class="margin-form" style="margin-top:0; padding-top:10px;">
                ...
                <div class="tab-content hide" id="tab-productpage2">
                        ...
                        <div class="roytc_row ds_wrap">
                              <label>' . $this->l('Radio Button style') . '</label>
                              <div class="margin-form">
                        ...
                        <div class="roytc_row">
                        <label>' . $this->l('Selected option border') . '</label>
                             <div class="margin-form">
                      ...
                      <div class="roytc_row">
                      <label>' . $this->l('Old Price color') . '</label>
                           <div class="margin-form">
                     ...
                     <div class="half_container low_paddings" style="display:inline-block; width:100%">
                        ...
                        <div class="roytc_row ds_wrap">
                              <label>' . $this->l('Old price display') . '</label>
                              <div class="margin-form">
          ...
          <label>' . $this->l('Text') . '</label>
            ...
            <div class="tab-pane" id ="tab-cart">
              ...
              <div class="roytc_row">
              <label>' . $this->l('Added background') . '</label>
                   <div class="margin-form">
        ...
        $html .= '
            ...
            <div class="tab-pane" id ="tab-blog">
                  ...
                  <div class="roytc_row ds_wrap">
                        <label>' . $this->l('Post container') . '</label>
                        <div class="margin-form" style="margin-top:0; padding-top:10px;">
               ...
               <div class="half" style="width:620px; padding-bottom:0;">
                  ...
                  <div class="roytc_row">
                        <label>' . $this->l('Header hover color') . '</label>
                        <div class="margin-form">
                 ...
                 <h3>' . $this->l('Home latest post design') . '</h3>
                  ...
                  <div class="half" style="width:620px; padding-bottom:0;">
                   ...
                   <h3>' . $this->l('Blog category') . '</h3>
                        ...
                        <div class="roytc_row ds_wrap">
                              <label>' . $this->l('Posts in a row') . '</label>
                              <div class="margin-form" style="margin-top:0; padding-top:10px;">
            ...
            <div class="tab-pane" id ="tab-css">
                    <h2 class="rtc_title12">' . $this->l('Custom CSS') . '</h2>
                        <div class="roytc_row">
                             <label style="width:250px;">' . $this->l('Put your Custom CSS here') . '</label>
