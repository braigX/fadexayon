...
- Fix indexation issue with multiple languagescr
...
## 4.3.18
- Products with attributes will now build links to the default id attribute
- Fix multishop indexation in cron mode

## 4.3.19
- Fix sorting with specific prices
- Fix statistics in ajax searches
- Fix issue with displayal of categories when display only default category parameter is active
- Improve compatibility with ttblocksearch module on mobile

## 4.3.20
- Fix issue with multishop links

## 4.3.21
- Add possibility to resume an indexation
- Improve cron indexation help

## 4.3.22
- Add compatibility with lab block search
- Fix cron indexation in multishop context
- Fix issue with a random zero value for product price on results page

## 4.3.23
- Fix header hook register on prestashop 1.7.7+
- Add labsearch theme compatibility

## 4.3.24
- Revert header hook fix from 4.3.23
- Fix word cutting issue

## 4.3.25
- Fix padding top of dropdown
- PHP 7.4 support
- fix issue with some URL rewriting in 1.7.7+
- add compatibility with Transformer theme
- add compatiblity with Bonsearch Ajax Search bar (universal theme)
- add compatibiltiy with foodstore theme for Prestashop 1.7+
- add compatibiltiy with universal theme for Prestashop 1.7+
- fix issue when sorting by price on products with combinations of different prices
- improve install process

## 4.3.26
- Fix install issue on 1.6.0.x
- Fix standard search results issue on versions < 1.6.1
- Fix indexation of single product
- Improve cron advices
- Empty synonyms during reindexation
- Enable proper indexation even for a single product
- Add class for themeing

# 4.3.27
- Display default supplier of products (optional)
- Add default supplier name to product index (optional) (Jolisearch indexation process required)
- Display matching suppliers (as categories or manufacturers) of searched products (optional)
- Fix issue with indexation when id_product values are superior to 2,300,000,000+
- Increase categories search performances
- Increase manufacturers search performances
- Fix issue with ZOneTheme (Prestashop 1.7+)
- Add support for at_movic Theme (Prestashop 1.7+)
- Allow partial reindexation in cron task

# 4.3.28
- Fix compatibility with AdvancedSearch4 v5.0.0+
- Cast step size as Int
- Compatibility with Theme Design Themes

# 4.4.0
- new mobile and responsive User eXperience
- add option to display in stock products first
- PHP 8.1 support
- Prestashop 8 compatibility
- improve performances
- improve indexation process
- fix CSS issues with Modern style
- add module translations for GB, FR, DA, CS, ES, DE, IT, NL, PL, SK, UK

# 4.4.1
- new mobile and responsive User eXperience
- fix issue with search modal on mobile
- optimize performances when searching with stock
- add compatiblity with electric theme
- fix installation issue on Prestashop 1.7.8.8+

# 4.4.2
- fix issue with secondary sort order
- fix issue that returns too many results in some cases when searching with word start option
- fix issue with mobile UX on safari browser
