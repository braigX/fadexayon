{if !empty($options.tips)}
    ...
    {/if}
    <img title="{$options.tips|escape:'htmlall':'UTF-8'}" id="{$tips_key|escape:'htmlall':'UTF-8'}-tips" class="pm_tips" src="{$module_path|sil_nofilter}views/img/question.png" width="16px" height="16px" />
