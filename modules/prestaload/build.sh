...
printf '{}\n' > "$CACHE_DIR/prestaload-cache-warmer.json"
printf '{}\n' > "$CACHE_DIR/prestaload-beta-cache-generator.json"
printf '{}\n' > "$CACHE_DIR/prestaload-features.json"
printf '' > "$CACHE_DIR/source.html"
printf '<?php return [];%s' $'\n' > "$RUNTIME_CONFIG_PATH"
...
echo "- $CACHE_DIR/prestaload-cache-warmer.json"
echo "- $CACHE_DIR/prestaload-beta-cache-generator.json"
echo "- $CACHE_DIR/prestaload-features.json"
echo "- $CACHE_DIR/source.html"
