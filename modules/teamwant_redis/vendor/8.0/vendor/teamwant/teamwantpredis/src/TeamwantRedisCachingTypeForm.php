...
class TeamwantRedisCachingTypeForm extends CachingType
{
    ...
    public static function getPerformanceForm($builder) {
        ...
        /** @var array $locales */
        $locales = $container->get('prestashop.adapter.legacy.context')->getLanguages();

        // $builder to już istniejący builder (Symfony\Component\Form\FormBuilderInterface)
        $formType = new self($translator, $locales);

        // Modyfikujesz istniejący builder:
