...
|---|---|
| [TeamwantRedis\Psr\Http\Message\MessageInterface](http://www.php-fig.org/psr/psr-7/#psrhttpmessagemessageinterface) | Representation of a HTTP message |
| [TeamwantRedis\Psr\Http\Message\RequestInterface](http://www.php-fig.org/psr/psr-7/#psrhttpmessagerequestinterface) | Representation of an outgoing, client-side request. |
| [TeamwantRedis\Psr\Http\Message\ServerRequestInterface](http://www.php-fig.org/psr/psr-7/#psrhttpmessageserverrequestinterface) | Representation of an incoming, server-side HTTP request. | 
| [TeamwantRedis\Psr\Http\Message\ResponseInterface](http://www.php-fig.org/psr/psr-7/#psrhttpmessageresponseinterface) | Representation of an outgoing, server-side response. |
| [TeamwantRedis\Psr\Http\Message\StreamInterface](http://www.php-fig.org/psr/psr-7/#psrhttpmessagestreaminterface) | Describes a data stream |
| [TeamwantRedis\Psr\Http\Message\UriInterface](http://www.php-fig.org/psr/psr-7/#psrhttpmessageuriinterface) | Value object representing a URI. |
| [TeamwantRedis\Psr\Http\Message\UploadedFileInterface](http://www.php-fig.org/psr/psr-7/#psrhttpmessageuploadedfileinterface) | Value object representing a file uploaded through an HTTP request. |

## `TeamwantRedis\Psr\Http\Message\MessageInterface` Methods
...
## `TeamwantRedis\Psr\Http\Message\RequestInterface` Methods

Same methods as `TeamwantRedis\Psr\Http\Message\MessageInterface`  + the following methods:
...
## `TeamwantRedis\Psr\Http\Message\ServerRequestInterface` Methods

Same methods as `TeamwantRedis\Psr\Http\Message\RequestInterface`  + the following methods:
...
## `TeamwantRedis\Psr\Http\Message\ResponseInterface` Methods:
...
##  `TeamwantRedis\Psr\Http\Message\StreamInterface` Methods
...
## `TeamwantRedis\Psr\Http\Message\UriInterface` Methods
...
## `TeamwantRedis\Psr\Http\Message\UploadedFileInterface` Methods
...
> When using `ServerRequestInterface`, both `RequestInterface` and `TeamwantRedis\Psr\Http\Message\MessageInterface` methods are considered.
