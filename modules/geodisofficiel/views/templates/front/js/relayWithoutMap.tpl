            ...
            <div class="geodisPrestationContent">
                <div class="geodisPrestationContent__container geodisPrestationContent__container--relay">
                    ...
                    <div class="geodisRelayPicker">
                        <div class="geodisRelayPicker__1column">
                            <div class="geodisRelayPicker__form">
                                <input class="geodisRelayShortAddress__input js-geodis-relay-zipcode" data-set-value="getZipCode" data-values="0" placeholder="{__ s='front.popin.zipcode.placeholder'}" />
                                <select class="geodisRelayShortAddress__country js-geodis-relay-country" data-set-value="getCountryCode">
                                    {foreach $geodisCountryList as $country}
                                        <option
                                            value="{$country.iso_code|escape:'htmlall':'UTF-8'}"
                                            {if $country.iso_code == $geodisCountryCode}
                                                selected="true"
                                            {/if}
                                        >{$country.name}</option>
                                    {/foreach}
                                </select>
                                <button class="geodisRelayShortAddress__action" data-values="0" data-action="updateRelayShortAddress">{__ s='front.popin.address.button'}</button>
                            </div>
                    ...
                    <div class="geodisInfo geodisInfo--relay">
                        <div class="js-input-container geodisInfo__inputContainer geodisInfo__inputContainer--telephone" data-required-text="{__ s='front.popin.requiredEntry'|escape:'html'}" data-error="{__ s='front.popin.telephone.error'|escape:'html'}">
                            <input class="geodisInfo__input js-telephone geodisInput__input" type="text" placeholder="{__ s='front.popin.telephone.placeholder'|escape:'html'}" data-set-value="getTelephone" data-validate="validateTelephone" data-process="processTelephone" data-change="switchRequiredEntry"/>
                        </div>
                        <div class="js-input-container geodisInput geodisInfo__inputContainer geodisInfo__inputContainer--mobilephone" data-required-text="{__ s='front.popin.requiredEntry'|escape:'html'}" data-error="{__ s='front.popin.mobile.error'|escape:'html'}">
                            <input class="geodisInfo__input js-mobilephone geodisInput__input" type="text" placeholder="{__ s='front.popin.mobile.placeholder'|escape:'html'}" data-set-value="getMobilephone" data-validate="validateMobilephone" data-process="processMobilephone" data-change="switchRequiredEntry"/>
                        </div>
