...
class AdminGeodisPackageLabelController extends ModuleAdminController
{
    public function __construct()
    {
        ...
        $response = GeodisServiceWebservice::getInstance()->getPackageLabel(array($shipment->recept_number));
        ...
        if (!empty($response)) {
            ...
            $pdfFile = 'labels-' . Tools::getValue('idShipment') . '.pdf';
