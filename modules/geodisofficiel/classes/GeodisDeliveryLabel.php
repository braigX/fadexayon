...
class GeodisDeliveryLabel extends ObjectModel
{
    public $id_shipment;
    public $content;
    public $date_add;
    ...
    public static $definition = array(
        'table' => GEODIS_NAME_SQL.'_delivery_label',
        'primary' => 'id_delivery_label',
        'fields' => array(
    ...
    public static function getFromExternal($idShipment)
    {
