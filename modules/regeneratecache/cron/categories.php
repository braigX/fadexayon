...
$offset = (int)Configuration::get('rc_categories_offset');
...
if(!$results)
{
	Configuration::updateValue('rc_categories_offset', 0);	
...
if($results)
{
	...
	Configuration::updateValue('rc_categories_offset', $offset + count($results)  );	
