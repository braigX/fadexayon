...
function upgrade_module_2_0_1()
{
    ...
    $queries[] = '
        ALTER TABLE `' . _DB_PREFIX_ .
            'lgcookieslaw_cookie` ADD `add_script_literal` tinyint(1) UNSIGNED NOT NULL DEFAULT \'0\'
            AFTER `add_literal_tag`;
    ';
    $queries[] = '
        UPDATE `' . _DB_PREFIX_ . 'lgcookieslaw_cookie` SET `add_script_literal` = `add_literal_tag`;
    ';
    $queries[] = '
        ALTER TABLE `' . _DB_PREFIX_ .
            'lgcookieslaw_cookie` DROP COLUMN `add_literal_tag`;
    ';
