...
<div id="unable_to_calculate_custom_shipping" style="display:none;">
    <h3>{l s='Sorry we are unable to calculate the shipping cost for your order at this time.' mod='customshippingrate'}</h3>
    ...
    <div id="spinner_loader">
        <img src="{$urls.base_url|escape:'htmlall':'UTF-8'}modules/customshippingrate/views/img/loader.gif" width="24" height="24">
    </div>
