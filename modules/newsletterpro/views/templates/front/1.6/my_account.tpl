...
<div id="newsletterpro-my-account" class="newsletterpro-my-account">
	{capture name=path}<a href="{$link->getPageLink('my-account', true)|escape:'quotes':'UTF-8'}">{l s='My account' mod='newsletterpro'}</a><span class="navigation-pipe">{$navigationPipe|escape:'html':'UTF-8'}</span>{l s='Newsletter Settings' mod='newsletterpro'}{/capture}
	{include file="$tpl_dir./errors.tpl"}

	<div class="box">
		<h1 class="page-heading">{l s='Newsletter Settings' mod='newsletterpro'}</h1>
