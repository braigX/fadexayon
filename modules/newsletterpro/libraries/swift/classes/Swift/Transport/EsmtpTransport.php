 ...
 * @author     Chris Corbyn
 */
class NewsletterPro_Swift_Transport_EsmtpTransport extends NewsletterPro_Swift_Transport_AbstractSmtpTransport implements NewsletterPro_Swift_Transport_SmtpAgent
{
    /**
     * ESMTP extension handlers.
     *
     * @var NewsletterPro_Swift_Transport_EsmtpHandler[]
     */
    ...
    private $_params = array(
        ...
        'blocking' => 1,
        'tls' => false,
        'type' => NewsletterPro_Swift_Transport_IoBuffer::TYPE_SOCKET,
        );
     ...
     * @param NewsletterPro_Swift_Transport_EsmtpHandler[] $extensionHandlers
     * @param NewsletterPro_Swift_Events_EventDispatcher   $dispatcher
     */
    public function __construct(NewsletterPro_Swift_Transport_IoBuffer $buf, array $extensionHandlers, NewsletterPro_Swift_Events_EventDispatcher $dispatcher)
    {
     ...
     * @param string $host
     *
     * @return NewsletterPro_Swift_Transport_EsmtpTransport
     */
     ...
     *
     * @param NewsletterPro_Swift_Transport_EsmtpHandler[] $handlers
     *
     * @return NewsletterPro_Swift_Transport_EsmtpTransport
     */
     ...
     *
     * @return NewsletterPro_Swift_Transport_EsmtpHandler[]
     */
        ...
        if ($this->_params['tls']) {
            try {
                ...
                if (!$this->_buffer->startTLS()) {
                    throw new NewsletterPro_Swift_TransportException('Unable to connect with TLS encryption');
                }
