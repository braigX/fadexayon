 ...
 * @author     Chris Corbyn
 */
class NewsletterPro_Swift_Transport_SendmailTransport extends NewsletterPro_Swift_Transport_AbstractSmtpTransport
{
    /**
    ...
    private $_params = array(
        ...
        'type' => NewsletterPro_Swift_Transport_IoBuffer::TYPE_PROCESS,
        );
     ...
     * NewsletterPro_Swift will append a -f<sender> flag if one is not present.
     *
     ...
     *
     * @return NewsletterPro_Swift_Transport_SendmailTransport
     */
    ...
    public function send(NewsletterPro_Swift_Mime_Message $message, &$failedRecipients = null)
    {
        ...
        if (false !== strpos($command, ' -t')) {
            ...
            $this->_throwException(new NewsletterPro_Swift_TransportException(
