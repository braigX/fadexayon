 ...
 * @author     Chris Corbyn
 */
class NewsletterPro_Swift_Plugins_PopBeforeSmtpPlugin implements NewsletterPro_Swift_Events_TransportChangeListener, NewsletterPro_Swift_Plugins_Pop_Pop3Connection
{
     ...
     * @param string  $crypto as "tls" or "ssl"
     *
     * @return NewsletterPro_Swift_Plugins_PopBeforeSmtpPlugin
     */
     ...
     *
     * @param NewsletterPro_Swift_Plugins_Pop_Pop3Connection $connection
     *
     * @return NewsletterPro_Swift_Plugins_PopBeforeSmtpPlugin
     */
    public function setConnection(NewsletterPro_Swift_Plugins_Pop_Pop3Connection $connection)
    {
     ...
     *
     * @param NewsletterPro_Swift_Transport
     */
    public function bindSmtp(NewsletterPro_Swift_Transport $smtp)
    {
     ...
     *
     * @throws NewsletterPro_Swift_Plugins_Pop_Pop3Exception if connection fails
     */
        ...
        if (isset($this->_connection)) {
            ...
            if (!isset($this->_socket)) {
                if (!$socket = fsockopen(
                    ...
                    throw new NewsletterPro_Swift_Plugins_Pop_Pop3Exception(
