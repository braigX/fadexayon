 ...
 */
class NewsletterPro_Swift_Plugins_DecoratorPlugin implements NewsletterPro_Swift_Events_SendListener, NewsletterPro_Swift_Plugins_Decorator_Replacements
{
    /** The replacement map */
     ...
     * of {@link NewsletterPro_Swift_Plugins_Decorator_Replacements}.
     *
     ...
     * </code>
     *
     * When using an instance of {@link NewsletterPro_Swift_Plugins_Decorator_Replacements},
     * the object should return just the array of replacements for the address
     * given to {@link NewsletterPro_Swift_Plugins_Decorator_Replacements::getReplacementsFor()}.
     *
     * @param mixed $replacements Array or NewsletterPro_Swift_Plugins_Decorator_Replacements
     */
    ...
    {
        if (!($replacements instanceof NewsletterPro_Swift_Plugins_Decorator_Replacements)) {
     ...
     * {@link NewsletterPro_Swift_Plugins_Decorator_Replacements} then the call will be
    ...
    {
        if ($this->_replacements instanceof NewsletterPro_Swift_Plugins_Decorator_Replacements) {
