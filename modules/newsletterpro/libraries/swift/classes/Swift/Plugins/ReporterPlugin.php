 ...
 * @author     Chris Corbyn
 */
class NewsletterPro_Swift_Plugins_ReporterPlugin implements NewsletterPro_Swift_Events_SendListener
{
    /**
     * The reporter backend which takes notifications.
     *
     * @var NewsletterPro_Swift_Plugins_Reporter
     */
    private $_reporter;
     ...
     *
     * @param NewsletterPro_Swift_Plugins_Reporter $reporter
     */
    public function __construct(NewsletterPro_Swift_Plugins_Reporter $reporter)
    {
    ...
    public function sendPerformed(NewsletterPro_Swift_Events_SendEvent $evt)
    {
        ...
        foreach ((array) $message->getTo() as $address => $null) {
            $this->_reporter->notify(
                ...
                ? NewsletterPro_Swift_Plugins_Reporter::RESULT_FAIL
                : NewsletterPro_Swift_Plugins_Reporter::RESULT_PASS)
            );
        }
