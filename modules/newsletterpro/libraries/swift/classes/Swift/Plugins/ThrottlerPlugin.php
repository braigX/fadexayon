 ...
 * @author     Chris Corbyn
 */
class NewsletterPro_Swift_Plugins_ThrottlerPlugin extends NewsletterPro_Swift_Plugins_BandwidthMonitorPlugin implements NewsletterPro_Swift_Plugins_Sleeper, NewsletterPro_Swift_Plugins_Timer
{
     ...
     *
     * @var NewsletterPro_Swift_Plugins_Sleeper
     */
    private $_sleeper;
     ...
     *
     * @var NewsletterPro_Swift_Plugins_Timer
     */
    private $_timer;
     ...
     * @param NewsletterPro_Swift_Plugins_Sleeper $sleeper (only needed in testing)
     * @param NewsletterPro_Swift_Plugins_Timer   $timer   (only needed in testing)
     */
    public function __construct($rate, $mode = self::BYTES_PER_MINUTE, NewsletterPro_Swift_Plugins_Sleeper $sleeper = null, NewsletterPro_Swift_Plugins_Timer $timer = null)
    {
        $this->_rate = $rate;
        $this->_mode = $mode;
