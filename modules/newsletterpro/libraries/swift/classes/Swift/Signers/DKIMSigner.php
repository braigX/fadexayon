 ...
 */
class NewsletterPro_Swift_Signers_DKIMSigner implements NewsletterPro_Swift_Signers_HeaderSigner
{
    /**
     * PrivateKey
     *
     ...
     * @param string $domainName
     * @param string $selector
     * @return NewsletterPro_Swift_Signers_DKIMSigner
     */
    ...
    /**
     * Reset the Signer
     * @see NewsletterPro_Swift_Signer::reset()
     */
    ...
    private function _getEncryptedHash()
    {
        ...
        if (!$pkeyId) {
            throw new NewsletterPro_Swift_SwiftException('Unable to load DKIM Private Key ['.openssl_error_string().']');
        }
        if (openssl_sign($this->_headerCanonData, $signature, $pkeyId, $algorithm)) {
            return $signature;
        }
        throw new NewsletterPro_Swift_SwiftException('Unable to sign DKIM Hash ['.openssl_error_string().']');
    }
}
