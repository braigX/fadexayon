 ...
 * @author  Chris Corbyn
 */
class NewsletterPro_Swift_DependencyContainer
{
     ...
     *
     * @return NewsletterPro_Swift_DependencyContainer
     */
     ...
     * @return mixed
     *
     * @throws NewsletterPro_Swift_DependencyException If the dependency is not found
     */
    public function lookup($itemName)
    {
        if (!$this->has($itemName)) {
            throw new NewsletterPro_Swift_DependencyException(
