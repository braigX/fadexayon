 ...
 * @author     Chris Corbyn
 */
class NewsletterPro_Swift_SendmailTransport extends NewsletterPro_Swift_Transport_SendmailTransport
{
    /**
    ...
    public function __construct($command = '/usr/sbin/sendmail -bs')
    {
        call_user_func_array(
            array($this, 'NewsletterPro_Swift_Transport_SendmailTransport::__construct'),
     ...
     * @param string $command
     *
     * @return NewsletterPro_Swift_SendmailTransport
     */
