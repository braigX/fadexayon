 ...
 * @author     Chris Corbyn
 */
class NewsletterPro_Swift_Message extends NewsletterPro_Swift_Mime_SimpleMessage
{
    /**
     * @var NewsletterPro_Swift_Signers_HeaderSigner[]
     */
    private $headerSigners = array();

    /**
     * @var NewsletterPro_Swift_Signers_BodySigner[]
     */
    ...
    public function __construct($subject = null, $body = null, $contentType = null, $charset = null)
    {
        call_user_func_array(
            array($this, 'NewsletterPro_Swift_Mime_SimpleMessage::__construct'),
     ...
     * @param string $charset
     *
     * @return NewsletterPro_Swift_Message
     */
     ...
     *
     * @param string|NewsletterPro_Swift_OutputByteStream $body
     * @param string                        $contentType
     * @param string                        $charset
     *
    ...
    {
        return $this->attach(NewsletterPro_Swift_MimePart::newInstance(
            $body,
            $contentType,
            $charset
        ));
     ...
     *
     * @param NewsletterPro_Swift_Signer $signer
     * @return NewsletterPro_Swift_Message
     */
    public function attachSigner(NewsletterPro_Swift_Signer $signer)
    {
        if ($signer instanceof NewsletterPro_Swift_Signers_HeaderSigner) {
            $this->headerSigners[] = $signer;
        } elseif ($signer instanceof NewsletterPro_Swift_Signers_BodySigner) {
     ...
     * @return NewsletterPro_Swift_Message
     */
    public function detachSigner(NewsletterPro_Swift_Signer $signer)
    {
        if ($signer instanceof NewsletterPro_Swift_Signers_HeaderSigner) {
    ...
    {
        NewsletterPro_Swift_DependencyContainer::getInstance()->createDependenciesFor('mime.message');
    }
     ...
     * @see NewsletterPro_Swift_Mime_SimpleMimeEntity::__clone()
     */
