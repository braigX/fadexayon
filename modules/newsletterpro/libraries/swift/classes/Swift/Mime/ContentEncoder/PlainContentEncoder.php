...
/**
 * Handles binary/7/8-bit Transfer Encoding in NewsletterPro_Swift Mailer.
 *
 * @author     Chris Corbyn
 */
class NewsletterPro_Swift_Mime_ContentEncoder_PlainContentEncoder implements NewsletterPro_Swift_Mime_ContentEncoder
{
    /**
