...
/**
 * Handles Quoted Printable (QP) Transfer Encoding in NewsletterPro_Swift Mailer using the PHP core function.
 *
 * @author     Lars Strojny
 */
class NewsletterPro_Swift_Mime_ContentEncoder_NativeQpContentEncoder implements NewsletterPro_Swift_Mime_ContentEncoder
{
    /**
     * @var null|string
     */
