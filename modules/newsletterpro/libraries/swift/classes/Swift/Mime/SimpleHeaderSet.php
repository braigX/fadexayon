 ...
 * @author     Chris Corbyn
 */
class NewsletterPro_Swift_Mime_SimpleHeaderSet implements NewsletterPro_Swift_Mime_HeaderSet
{
    /** HeaderFactory */
    private $_factory;
     ...
     *
     * @param NewsletterPro_Swift_Mime_HeaderFactory $factory
     * @param string                   $charset
     */
    public function __construct(NewsletterPro_Swift_Mime_HeaderFactory $factory, $charset = null)
    {
     ...
     * @param int               $index
     */
    public function set(NewsletterPro_Swift_Mime_Header $header, $index = 0)
    {
    ...
    private function _storeHeader($name, NewsletterPro_Swift_Mime_Header $header, $offset = null)
    {
    ...
    private function _isDisplayed(NewsletterPro_Swift_Mime_Header $header)
    {
