 ...
 * @author     Chris Corbyn
 */
class NewsletterPro_Swift_Mime_Attachment extends NewsletterPro_Swift_Mime_SimpleMimeEntity
{
     ...
     *
     * @param NewsletterPro_Swift_FileStream $file
     * @param string           $contentType optional
     *
     * @return NewsletterPro_Swift_Mime_Attachment
     */
    public function setFile(NewsletterPro_Swift_FileStream $file, $contentType = null)
    {
