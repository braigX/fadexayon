 ...
 * @author     Chris Corbyn
 */
class NewsletterPro_Swift_Mime_SimpleMimeEntity implements NewsletterPro_Swift_Mime_MimeEntity
{
     ...
     */
    public function __construct(NewsletterPro_Swift_Mime_HeaderSet $headers, NewsletterPro_Swift_Mime_ContentEncoder $encoder, NewsletterPro_Swift_KeyCache $cache, NewsletterPro_Swift_Mime_Grammar $grammar)
    {
    ...
    /**
     * Get the {@link NewsletterPro_Swift_Mime_HeaderSet} for this entity.
     *
     * @return NewsletterPro_Swift_Mime_HeaderSet
     */
     ...
     * @param string $type
     *
     * @return NewsletterPro_Swift_Mime_SimpleMimeEntity
     */
     ...
     *
     * @return NewsletterPro_Swift_Mime_MimeEntity[]
     */
     ...
     *
     * @param NewsletterPro_Swift_Mime_MimeEntity[] $children
    ...
    {
        return ($this->_body instanceof NewsletterPro_Swift_OutputByteStream)
     ...
     * {@link NewsletterPro_Swift_OutputByteStream}.
     *
     * @param mixed  $body
     ...
     * @return NewsletterPro_Swift_Mime_SimpleMimeEntity
     */
    public function setEncoder(NewsletterPro_Swift_Mime_ContentEncoder $encoder)
    {
     ...
     * @return NewsletterPro_Swift_Mime_SimpleMimeEntity
     *
     * @throws NewsletterPro_Swift_RfcComplianceException
     */
     ...
     * @param NewsletterPro_Swift_Mime_ContentEncoder $encoder
     */
    public function encoderChanged(NewsletterPro_Swift_Mime_ContentEncoder $encoder)
    {
        $this->_notifyEncoderChanged($encoder);
    }
        ...
        if (isset($this->_body) && empty($this->_immediateChildren)) {
            if ($this->_cache->hasKey($this->_cacheKey, 'body')) {
                ...
                $this->_cache->setString(
                    ...
                    'body',
                    $body,
                    NewsletterPro_Swift_KeyCache::MODE_WRITE
                );
            }
            $string .= $body;
        }
    ...
    /**
     * Write this entire entity to a {@see NewsletterPro_Swift_InputByteStream}.
     *
     * @param NewsletterPro_Swift_InputByteStream
     */
    public function toByteStream(NewsletterPro_Swift_InputByteStream $is)
    {
    ...
    /**
     * Write this entire entity to a {@link NewsletterPro_Swift_InputByteStream}.
     *
     * @param NewsletterPro_Swift_InputByteStream
     */
    protected function _bodyToByteStream(NewsletterPro_Swift_InputByteStream $is)
    {
        if (empty($this->_immediateChildren)) {
            if (isset($this->_body)) {
                if ($this->_cache->hasKey($this->_cacheKey, 'body')) {
                    ...
                    if ($this->_body instanceof NewsletterPro_Swift_OutputByteStream) {
     ...
     *
     * @return NewsletterPro_Swift_KeyCache
     */
     ...
     *
     * @return NewsletterPro_Swift_Mime_Grammar
     */
    ...
    private function _readStream(NewsletterPro_Swift_OutputByteStream $os)
    {
        $string = '';
    ...
    private function _assertValidBoundary($boundary)
    {
        if (!preg_match(
            ...
            throw new NewsletterPro_Swift_RfcComplianceException('Mime boundary set is not RFC 2046 compliant.');
        }
    }
    ...
    private function _notifyEncoderChanged(NewsletterPro_Swift_Mime_ContentEncoder $encoder)
    {
        foreach ($this->_immediateChildren as $child) {
    ...
    private function _assertValidId($id)
    {
        if (!preg_match(
            ...
            throw new NewsletterPro_Swift_RfcComplianceException(
                'Invalid ID given <'.$id.'>'
            );
        }
    }
