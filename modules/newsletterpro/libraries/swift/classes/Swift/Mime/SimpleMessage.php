 ...
 * @author     Chris Corbyn
 */
class NewsletterPro_Swift_Mime_SimpleMessage extends NewsletterPro_Swift_Mime_MimePart implements NewsletterPro_Swift_Mime_Message
{
    /**
     ...
     */
    public function __construct(NewsletterPro_Swift_Mime_HeaderSet $headers, NewsletterPro_Swift_Mime_ContentEncoder $encoder, NewsletterPro_Swift_KeyCache $cache, NewsletterPro_Swift_Mime_Grammar $grammar, $charset = null)
    {
     ...
     *
     * @return NewsletterPro_Swift_Mime_SimpleMessage
     */
    ...
    public function getPriority()
    {
        list($priority) = sscanf(
            $this->_getHeaderFieldModel('X-Priority'),
            '%[1-5]'
        );
    ...
    /**
     * Attach a {@link NewsletterPro_Swift_Mime_MimeEntity} such as an Attachment or MimePart.
     *
     * @param NewsletterPro_Swift_Mime_MimeEntity $entity
     *
     * @return NewsletterPro_Swift_Mime_SimpleMessage
     */
    public function attach(NewsletterPro_Swift_Mime_MimeEntity $entity)
    {
     ...
     * @return NewsletterPro_Swift_Mime_SimpleMessage
     */
    public function detach(NewsletterPro_Swift_Mime_MimeEntity $entity)
    {
        $newChildren = array();
    ...
    /**
     * Attach a {@link NewsletterPro_Swift_Mime_MimeEntity} and return it's CID source.
     ...
     * @return string
     */
    public function embed(NewsletterPro_Swift_Mime_MimeEntity $entity)
    {
        $this->attach($entity);
    ...
    /**
     * Write this message to a {@link NewsletterPro_Swift_InputByteStream}.
     *
    ...
    /** @see NewsletterPro_Swift_Mime_SimpleMimeEntity::_getIdField() */
