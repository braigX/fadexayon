 ...
 * @author     Chris Corbyn
 */
abstract class NewsletterPro_Swift_Mime_Headers_AbstractHeader implements NewsletterPro_Swift_Mime_Header
{
    /**
     ...
     *
     * @var NewsletterPro_Swift_Encoder
     */
    private $_encoder;
     ...
     */
    public function __construct(NewsletterPro_Swift_Mime_Grammar $grammar)
    {
     ...
     */
    public function setEncoder(NewsletterPro_Swift_Mime_HeaderEncoder $encoder)
    {
     ...
     *
     * @return NewsletterPro_Swift_Mime_HeaderEncoder
     */
     ...
     * @param NewsletterPro_Swift_Mime_Grammar $grammar
     */
    public function setGrammar(NewsletterPro_Swift_Mime_Grammar $grammar)
    {
     ...
     *
     * @param NewsletterPro_Swift_Mime_Header        $header
     ...
     * @return string
     */
    protected function createPhrase(NewsletterPro_Swift_Mime_Header $header, $string, $charset, NewsletterPro_Swift_Mime_HeaderEncoder $encoder = null, $shorten = false)
    {
     ...
     * @return string
     */
    protected function encodeWords(NewsletterPro_Swift_Mime_Header $header, $input, $usedLength = -1)
    {
        $value = '';
