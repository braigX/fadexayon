 ...
 * @author     Chris Corbyn
 */
class NewsletterPro_Swift_Mime_Headers_MailboxHeader extends NewsletterPro_Swift_Mime_Headers_AbstractHeader
{
    /**
     ...
     */
    public function __construct($name, NewsletterPro_Swift_Mime_HeaderEncoder $encoder, NewsletterPro_Swift_Mime_Grammar $grammar)
    {
     ...
     * <code>
     * <?php
     * $header = new NewsletterPro_Swift_Mime_Headers_MailboxHeader('From',
     ...
     *
     * @throws NewsletterPro_Swift_RfcComplianceException If invalid.
     */
