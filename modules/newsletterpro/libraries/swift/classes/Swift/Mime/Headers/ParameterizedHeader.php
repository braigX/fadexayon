 ...
 * @author     Chris Corbyn
 */
class NewsletterPro_Swift_Mime_Headers_ParameterizedHeader extends NewsletterPro_Swift_Mime_Headers_UnstructuredHeader implements NewsletterPro_Swift_Mime_ParameterizedHeader
{
    /**
     ...
     * @param NewsletterPro_Swift_Encoder            $paramEncoder, optional
     * @param NewsletterPro_Swift_Mime_Grammar       $grammar
     */
    public function __construct($name, NewsletterPro_Swift_Mime_HeaderEncoder $encoder, NewsletterPro_Swift_Encoder $paramEncoder = null, NewsletterPro_Swift_Mime_Grammar $grammar)
    {
