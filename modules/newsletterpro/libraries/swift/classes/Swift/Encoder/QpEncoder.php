...
/**
 * Handles Quoted Printable (QP) Encoding in NewsletterPro_Swift Mailer.
 *
 * Possibly the most accurate RFC 2045 QP implementation found in PHP.
 *
 * @author     Chris Corbyn
 */
class NewsletterPro_Swift_Encoder_QpEncoder implements NewsletterPro_Swift_Encoder
{
    /**
     * The CharacterStream used for reading characters (as opposed to bytes).
     *
     * @var NewsletterPro_Swift_CharacterStream
     */
     ...
     *
     * @var NewsletterPro_Swift_StreamFilter
     */
    protected $_filter;
     ...
     *
     * @param NewsletterPro_Swift_CharacterStream $charStream to use for reading characters
     * @param NewsletterPro_Swift_StreamFilter    $filter     if input should be canonicalized
     */
    public function __construct(NewsletterPro_Swift_CharacterStream $charStream, NewsletterPro_Swift_StreamFilter $filter = null)
    {
