...
class AdminSteSeoSitemapController extends ModuleAdminController
{
    ...
    public function initContent()
    {
        ...
        foreach ($shops as $shop) {
            ...
            if (!$robotsContent && file_exists($basePath . '/robots.txt')) {
                $robotsContent = file_get_contents($basePath . '/robots.txt');
            }
    ...
    private function updateRobots()
    {
        ...
        if ($manager->updateRobotsTxt(_PS_ROOT_DIR_ . '/robots.txt', $links)) {
            $this->confirmations[] = "Physical robots.txt updated with all shop sitemaps.";
        } else {
