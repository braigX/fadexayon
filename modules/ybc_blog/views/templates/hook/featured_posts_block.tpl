                        ...
                        {if $allowComments || $show_views || $allow_like} 
                            <div class="ybc-blog-latest-toolbar">
                                ...
                                {if $allowComments && $post.comments_num>0}
                                    ...
                                    {l s='comments' mod='ybc_blog'}{else}
                                    {l s='comment' mod='ybc_blog'}{/if}
                                    </span> 
                                {/if}                             
                                {if $allow_like}
