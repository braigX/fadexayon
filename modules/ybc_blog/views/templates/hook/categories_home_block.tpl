...
*}
{if isset($categoires) && $categoires}
    {foreach from=$categoires item='category'}
        {if isset($category.posts) && $category.posts}
            <div class="block ybc_block_category {$blog_config.YBC_BLOG_RTL_CLASS|escape:'html':'UTF-8'} {if isset($blog_page) && $blog_page}page_{$blog_page|escape:'html':'UTF-8'}{else}page_blog{/if} {if isset($blog_page) && $blog_page=='home'}{if isset($blog_config.YBC_BLOG_HOME_POST_TYPE) && $blog_config.YBC_BLOG_HOME_POST_TYPE=='default' || count($category.posts)<=1}ybc_block_default{else}ybc_block_slider{/if}{else}{if isset($blog_config.YBC_BLOG_SIDEBAR_POST_TYPE) && $blog_config.YBC_BLOG_SIDEBAR_POST_TYPE=='default' || count($category.posts)<=1}ybc_block_default{else}ybc_block_slider{/if}{/if}">
                ...
                <div class="ybc_blog_content_block {if  count($category.posts)>=1 && $blog_config.YBC_BLOG_SIDEBAR_POST_TYPE!='default'}blog_type_slider{/if}">
                    {foreach from=$category.posts item='post'}
                        <div class="ybc_blog_content_block_item{if $blog_page=='home'} col-xs-12 col-sm-4 col-lg-{12/$product_row|intval}{/if}">
                            ...
                            <div class="ybc-blog-latest-post-content">
                                    ...
                                    <div class="ybc-blog-latest-toolbar">
                                        {if $show_views}
                                            <span class="ybc-blog-latest-toolbar-views"><i class="ets_svg">
                                                ...
                                                {if $post.click_number!=1}{l s='views' mod='ybc_blog'}
                                                {else}{l s='view' mod='ybc_blog'}{/if}</span>
                                        {/if}   
                                        {if $allowComments}
                                ...
                                {/if}
                                {if isset($display_desc) && $display_desc}
