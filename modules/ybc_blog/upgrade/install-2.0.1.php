...
function upgrade_module_2_0_1($object)
{
    ...
    `description` TEXT NOT NULL) ENGINE="._MYSQL_ENGINE_." DEFAULT CHARSET=UTF8";
    foreach($sqls as $sql)
    {
