...
function upgrade_module_3_2_0($object)
{
    ...
    $sqls = array();
    if(!Ybc_blog_defines::checkCreatedColumn('ybc_blog_category_lang','image'))
    {
    ...
    if(!Ybc_blog_defines::checkCreatedColumn('ybc_blog_gallery_lang','image'))
    {
    ...
    if(!Ybc_blog_defines::checkCreatedColumn('ybc_blog_post_lang','image'))
    {
    ...
    if(!Ybc_blog_defines::checkCreatedColumn('ybc_blog_slide_lang','image'))
    {
