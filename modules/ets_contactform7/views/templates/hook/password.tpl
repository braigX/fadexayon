...
<div id="tag-generator-panel-password" class="hidden">
    <form action="" class="tag-generator-panel" data-id="password">
        <div class="control-box">
            <fieldset>
                <legend>{l s='Generate a form-tag for password input field. For more details, see ' mod='ets_contactform7'}
                    <a href="{$link_doc|escape:'html':'UTF-8'}#fi-password-field"
                       target="_blank">{l s='Password field' mod='ets_contactform7'}</a>.
                </legend>
