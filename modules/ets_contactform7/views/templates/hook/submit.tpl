...
<div id="tag-generator-panel-submit" class="hidden">
    <form action="" class="tag-generator-panel" data-id="submit"><div class="control-box">
        <fieldset>
        <legend>{l s='Generate a form-tag for a submit button. For more details, see' mod='ets_contactform7'} <a href="{$link_doc|escape:'html':'UTF-8'}#submit-button" target="_blank">{l s='Submit Button' mod='ets_contactform7'}</a>.</legend>
