        ...
        {else}
            ...
            {if trim($input.name) === 'ETS_ABANCART_MAIL_API_KEY'}
                <p class="help-block">
                    ...
                    <a target="_blank" rel="noreferrer noopener" class="ets-ab-config-mail sendinblue" href="https://help.brevo.com/hc/en-us/articles/209467485-Create-and-manage-your-API-keys">{l s='How to get key?' mod='ets_abandonedcart'}</a>
                </p>
            {/if}
