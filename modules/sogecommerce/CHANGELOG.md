...
- Bug fix: Consider the "Refunded with Sogecommerce" order status as a final status.
...
- Possibility to disable payment result display on order details using a flag within sogecommerce.php file (on PrestaShop > 1.7.1.1).
