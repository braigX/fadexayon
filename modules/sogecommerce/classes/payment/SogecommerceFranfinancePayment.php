...
class SogecommerceFranfinancePayment extends AbstractSogecommercePayment
{
    protected $prefix = 'SOGECOMMERCE_FFIN_';
    ...
    public static function getAvailableOptions($cart)
    {
        ...
        $options = @unserialize(Configuration::get('SOGECOMMERCE_FFIN_OPTIONS'));
    ...
    public function getTplVars($cart)
    {
        ...
        $vars['sogecommerce_ffin_options'] = self::getAvailableOptions($cart);
