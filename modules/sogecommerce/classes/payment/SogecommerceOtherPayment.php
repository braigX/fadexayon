...
class SogecommerceOtherPayment extends AbstractSogecommercePayment
{
    protected $prefix = 'SOGECOMMERCE_OTHER_';
    ...
    public function getTplVars($cart)
    {
        ...
        $vars['sogecommerce_other_payment_code'] = $this->payment_code;
        $vars['sogecommerce_other_payment_label'] = $cards[$this->payment_code];
    ...
    public function getPaymentOption($cart)
    {
        ...
        $inputs[] = array('type' => 'hidden', 'name' => 'sogecommerce_payment_code', 'value' => $this->payment_code);
        $inputs[] = array('type' => 'hidden', 'name' => 'sogecommerce_payment_title', 'value' => $this->getTitle((int) $cart->id_lang));
    ...
    public static function getAvailablePaymentMeans($cart = null)
    {
        ...
        $data_entry_mode = Configuration::get('SOGECOMMERCE_STD_CARD_DATA_MODE');
