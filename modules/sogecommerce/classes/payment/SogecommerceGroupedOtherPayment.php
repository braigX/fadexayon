...
class SogecommerceGroupedOtherPayment extends AbstractSogecommercePayment
{
    ...
    public function getTplVars($cart)
    {
        ...
        $vars['sogecommerce_other_options'] = $options;
    ...
    public function prepareRequest($cart, $data = array())
    {
        ...
        $available_payments = SogecommerceOtherPayment::getAvailablePaymentMeans($cart);
        $validation_mode = '-1';
        $capture_delay = '';
