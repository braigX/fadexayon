...
class SogecommerceChoozeoPayment extends AbstractSogecommercePayment
{
    protected $prefix = 'SOGECOMMERCE_CHOOZEO_';
    ...
    public static function getAvailableOptions($cart = null)
    {
        ...
        $options = @unserialize(Configuration::get('SOGECOMMERCE_CHOOZEO_OPTIONS'));
    ...
    public function getTplVars($cart)
    {
        ...
        $vars['sogecommerce_choozeo_options'] = self::getAvailableOptions($cart);
