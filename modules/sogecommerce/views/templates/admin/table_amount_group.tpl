...
<thead>
  <tr>
    <th>{l s='Customer group' mod='sogecommerce'}</th>
    <th>{l s='Minimum amount' mod='sogecommerce'}</th>
    {if !isset($min_only) || !$min_only}<th>{l s='Maximum amount' mod='sogecommerce'}</th>{/if}
  </tr>
</thead>

<tbody>
  <tr style="background-color: #bebebe;">
    <td>{l s='ALL GROUPS' mod='sogecommerce'}</td>
    <td>
