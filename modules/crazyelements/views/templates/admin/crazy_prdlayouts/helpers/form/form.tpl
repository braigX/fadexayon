...
{block name="label"}
    {if $input.type == 'crazy_productlayoutbuilder_content_type'}
    ...
    {elseif $input.type == 'hidden_random_product'}  
        <input type="hidden" value="{$input.value}" name="random_product" id="random_product">  
    {else}
        {$smarty.block.parent}
    {/if}
{/block}
