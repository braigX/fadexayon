                ...
                {/if}
                    {foreach from=$crazy_products item="product"}
                        <div class="{$column} {$six_col_class}">
                            <div class="product_inner_style4 cr-pr-inner">
                                <div class="thumbnail">
                                            ...
                                            {block name='product_add_to_cart'}
                                                {if !$configuration.is_catalog}
                                                    ...
                                                    <div class="product-quantity clearfix">
                                                        ...
                                                        {hook h='displayProductActions' product=$crazy_products}
                                                    </div>
                                                    {/block}
                                ...
                                <div class="lower-content">
                                    ...
                                    <a href="{$product.link}"><h3 class="product-title">{$product.name}</h3></a>
                                    {if $ed_short_desc}
