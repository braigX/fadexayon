...
class Widget_ProductCategory extends Widget_Base {
	...
	protected function _register_controls() {
		...
		$this->general_controls($control, true, 'random_query');
	...
	protected function render() {
		...
		$this->generate_controls_data($settings, 'id_category');
		...
		if ( $this->layout == 'default' ) {
			...
			$this->show_default_skin($products_for_template, 'products-category', $display_type);
		} else {
			if($random_query == 'yes'){
			...
			$this->show_crazy_skins($products_for_template, 'products-category');
		} 
	}
