...
class Widget_BestSellerProducts extends Widget_Base {
	...
	public function get_title() {
		return PrestaHelper::__( 'Best Seller Products', 'elementor' );
	}
	...
	public function get_icon() {
		return 'ceicon-best-seller-widget';
	}
	...
	protected function _register_controls() {
		...
		$this->general_controls(array(), false, false);
		...
		$this->add_control(
			...
			array(
				...
				'options' => array(
					'quantity'   => PrestaHelper::__( 'Quantity', 'elementor' ),
					'date_add'     => PrestaHelper::__( 'Published Date', 'elementor' ),
					'date_upd'     => PrestaHelper::__( 'Update Date', 'elementor' )
				),
				'default' => 'quantity',
			)
		);
	...
	protected function render() {
		...
		$cache_products = \ProductSaleCore::getBestSales( (int) $id_lang, 1, $limit,$orderby, $order );
		if ( ! $cache_products ) {
			echo 'No Bestseller Product Found';
			return false;
		}
		...
		if ( $this->layout == 'default' ) {
			...
			$this->show_default_skin($products_for_template, 'bestseller-products', $display_type);
		} else {
			$this->show_crazy_skins($products_for_template, 'bestseller-products');
		}
	}
