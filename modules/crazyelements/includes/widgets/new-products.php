...
class Widget_NewProducts extends Widget_Base {
	...
	public function get_title() {
		return PrestaHelper::__( 'New Products', 'elementor' );
	}
	...
	public function get_icon() {
		return 'ceicon-new-products-widget';
	}
	...
	protected function render() {
		...
		$cache_products = \Product::getNewProducts( (int) $id_lang, 1, $limit, false, $orderby, $order );
		if ( ! $cache_products ) {
			return false;
		}
		if ( ! $cache_products ) {
		...
		if ( $this->layout == 'default' ) {
			...
			$this->show_default_skin($products_for_template, 'new-products', $display_type);
		} else {
			$this->show_crazy_skins($products_for_template, 'new-products');
		}
	}
