...
class Widget_SpecialProducts extends Widget_Base {
	use Product_Trait;
	...
	public function get_title() {
		return PrestaHelper::__( 'Special Products', 'elementor' );
	}
	...
	protected function _register_controls() {
			...
			$this->general_controls(array(), true, false);
	...
	protected function render() {
		...
		$cache_products = \Product::getPricesDrop( (int) $id_lang, 1, $limit, false, $orderby, $order, false, false, $this->current_context );

		if ( ! $cache_products ) {
			echo 'No Special Products Found';
			return false;
		}
		...
		if ( $this->layout == 'default' ) {
			...
			$this->show_default_skin($products_for_template, 'special-products', $display_type);
		} else {
			$this->show_crazy_skins($products_for_template, 'special-products');
		}
	}
