...
class Element_Section extends Element_Base {
	...
	public function get_title() {
		return PrestaHelper::__( 'Section', 'elementor' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'stretch_section',
			[
				'label' => PrestaHelper::__( 'Stretch Section', 'elementor' ),
				'type' => Controls_Manager::SWITCHER,
				'default' => '',
				'return_value' => 'section-stretched',
				'prefix_class' => 'elementor-',
				'hide_in_inner' => true,
				'description' => PrestaHelper::__( 'Stretch the section to the full width of the page using JS.', 'elementor' ) . sprintf( ' <a href="%1$s" target="_blank">%2$s</a>', 'https://classydevs.com/docs/crazy-elements/', PrestaHelper::__( 'Learn more.', 'elementor' ) ),
				'render_type' => 'none',
		...
		$this->add_control(
			...
			[
				...
				'default' => 'boxed',
				'options' => [
					'boxed' => PrestaHelper::__( 'Boxed', 'elementor' ),
					'full_width' => PrestaHelper::__( 'Full Width', 'elementor' ),
				],
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'no' => PrestaHelper::__( 'No Gap', 'elementor' ),
					'narrow' => PrestaHelper::__( 'Narrow', 'elementor' ),
					'extended' => PrestaHelper::__( 'Extended', 'elementor' ),
					'wide' => PrestaHelper::__( 'Wide', 'elementor' ),
					'wider' => PrestaHelper::__( 'Wider', 'elementor' ),
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					'default' => PrestaHelper::__( 'Default', 'elementor' ),
					'full' => PrestaHelper::__( 'Fit To Screen', 'elementor' ),
					'min-height' => PrestaHelper::__( 'Min Height', 'elementor' ),
				],
		...
		$this->add_responsive_control(
			'custom_height',
			[
				'label' => PrestaHelper::__( 'Minimum Height', 'elementor' ),
				'type' => Controls_Manager::SLIDER,
				'default' => [
					'size' => 400,
				],
		...
		$this->add_control(
			'column_position',
			[
				'label' => PrestaHelper::__( 'Column Position', 'elementor' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'middle',
				'options' => [
					'stretch' => PrestaHelper::__( 'Stretch', 'elementor' ),
		...
		$this->add_control(
			'overflow',
			[
				'label' => PrestaHelper::__( 'Overflow', 'elementor' ),
				'type' => Controls_Manager::SELECT,
				'default' => '',
				'options' => [
					'' => PrestaHelper::__( 'Default', 'elementor' ),
					'hidden' => PrestaHelper::__( 'Hidden', 'elementor' ),
				],
				'selectors' => [
		...
		$this->add_control(
			'structure',
			[
				'label' => PrestaHelper::__( 'Structure', 'elementor' ),
		...
		$this->start_controls_section(
			...
			[
				'label' => PrestaHelper::__( 'Shape Divider', 'elementor' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		...
		foreach ( [
			...
			$this->add_control(
				...
				[
					'label' => PrestaHelper::__( 'Flip', 'elementor' ),
					'type' => Controls_Manager::SWITCHER,
					'condition' => [
			...
			$this->add_control(
				...
				[
					'label' => PrestaHelper::__( 'Invert', 'elementor' ),
					'type' => Controls_Manager::SWITCHER,
					'frontend_available' => true,
					'condition' => [
		...
		$this->add_control(
			...
			[
				'label' => PrestaHelper::__( 'Reverse Columns', 'elementor' ) . ' (' . PrestaHelper::__( 'Tablet', 'elementor' ) . ')',
				'type' => Controls_Manager::SWITCHER,
				'default' => '',
				'prefix_class' => 'elementor-',
		...
		$this->add_control(
			...
			[
				'label' => PrestaHelper::__( 'Reverse Columns', 'elementor' ) . ' (' . PrestaHelper::__( 'Mobile', 'elementor' ) . ')',
				'type' => Controls_Manager::SWITCHER,
				'default' => '',
				'prefix_class' => 'elementor-',
		...
		$this->add_control(
			'heading_visibility',
			[
				'label' => PrestaHelper::__( 'Visibility', 'elementor' ),
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'prefix_class' => 'elementor-',
				'label_on' => PrestaHelper::__( 'Hide', 'elementor' ),
				'label_off' => PrestaHelper::__( 'Show', 'elementor' ),
	...
	protected function _content_template() {
		...
		<div class="elementor-container fgdfgdf elementor-column-gap-{{ settings.gap }}">
	...
	public function before_render() {
		...
		?>
		<<?php echo PrestaHelper::esc_html( $this->get_html_tag() ); ?> <?php $this->print_render_attribute_string( '_wrapper' ); ?>>
			<?php
			...
			<div class="elementor-container elementor-column-gap-<?php echo PrestaHelper::esc_attr( $settings['gap'] ); ?>">
	...
	public function after_render() {
		...
		</<?php echo PrestaHelper::esc_html( $this->get_html_tag() ); ?>>
		<?php
	}
	...
	private function print_shape_divider( $side ) {
		...
		?>
		<div class="elementor-shape elementor-shape-<?php echo PrestaHelper::esc_attr( $side ); ?>" data-negative="<?php echo var_export( $negative ); ?>">
