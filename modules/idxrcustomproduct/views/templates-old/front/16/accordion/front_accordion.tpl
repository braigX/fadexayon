        ...
        <div id="component_steps_container" class="panel-group" data-type='accordion'>            
            ...
            <div id="component_step_last" class="col-lg-12 component_step"> 
                <div class="panel" style="border-color: {$steps.final_color|escape:'htmlall':'UTF-8'}">
                    <div class="panel-heading" style="background-color: {$steps.final_color|escape:'htmlall':'UTF-8'};color:#ffffff">
                        <a data-toggle="collapse" data-parent="#component_steps_container" href="#component_step_resume" >
                            <div id="alignment" >
                                <h4>                            
                                    <i class="fa fa-list icon icon-list"></i> molkhass 2                           
                                </h4>
                                <span id="toggle_block_last" class="toggle_arrow">  </span>
                            </div>
                        </a>
                    </div>
                    <div id="component_step_resume" class="{if $steps.resume_open == 0}panel-collapse collapse{/if}">
                                ...
                                <td>
                                    <h4 class="pull-right">
                                        ...
                                        <span id='resume_total_price'>
                                            {if $priceDisplay == 1}
                                                {if isset($icp_price_wo_wd_formated)}{$icp_price_wo_wd_formated}{else}{$icp_price_wo_formated|escape:'htmlall':'UTF-8'}{/if}
                                            {else}
                                                {if isset($icp_price_wd_formated)}{$icp_price_wd_formated}{else}{$icp_price_formated|escape:'htmlall':'UTF-8'}{/if}
                                            {/if}
                                    </h4>
                                </td>
                                </tr>
