...
class IdxrCustomProduct extends Module
{
    ...
    public function install()
    {
        ...
        return parent::install() && $this->registerHook('displayBackOfficeTop') 
                ...
                && $this->registerHook('displayProductTabContent') && $this->registerHook('displayProductAdditionalInfo') 
    ...
    public function hookDisplayProductAdditionalInfo($params)
    {
        ...
        return $this->displayCustomization($params, 'hookDisplayProductAdditionalInfo');
    }
                ...
                'input' => array(
                    ...
                    array(
                        ...
                        'options' => array(
                            'query' => array(
                                1 => array(
                                    'hook' => $this->es17 ? 'hookDisplayProductAdditionalInfo' : 'hookDisplayRightColumnProduct',
