...
([
    ...
    (function(module, exports, __webpack_require__) {
        ...
        exports.default = void 0;
        var _handler = _interopRequireDefault(__webpack_require__(225));
        ...
        var _default =
            ...
            function(_elementorModules$Mod) {
                ...
                function _default() {
                    (0, _classCallCheck2.default)(this, _default);
                    var _this = (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf2.default)(_default).apply(this, arguments))
                    elementorFrontend.hooks.addAction('frontend/element_ready/global',function ($element) {
                        elementorFrontend.elementsHandler.addHandler(_handler.default, { $element: $element });
                    });
                    return _this;
                }
                return _default;
    ...
    (function(module, exports, __webpack_require__) {
        ...
        var _motionFx = _interopRequireDefault(__webpack_require__(227));
        var _classCallCheck2 = _interopRequireDefault(__webpack_require__(6));
        var _createClass2 = _interopRequireDefault(__webpack_require__(7));
        var _possibleConstructorReturn2 = _interopRequireDefault(__webpack_require__(10));
        var _getPrototypeOf2 = _interopRequireDefault(__webpack_require__(4));
        ...
        var _default =
            /*#__PURE__*/
            function(_elementorModules$Pro) {
                (0, _inherits2.default)(_default, _elementorModules$Pro);
                function _default() {
                    (0, _classCallCheck2.default)(this, _default);
                    return (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf2.default)(_default).apply(this, arguments));
                }
                (0, _createClass2.default)(_default, [
		            ...
		            value: function bindEvents() {
                        elementorFrontend.elements.$window.on('resize', this.toggle_motion);
                      }
                },{
                    key: 'unbindEvents',
                        value: function unbindEvents() {
                        elementorFrontend.elements.$window.off('resize', this.toggle_motion);
                    }
                },{
                    key: 'addCSSTransformEvents',
                      ...
                      value: function onDestroy() {
                        (0, _get2.default)((0, _getPrototypeOf2.default)(_default.prototype), "onDestroy", this).call(this);
    ...
    (function(module, exports, __webpack_require__) {
        ...
        var _base = _interopRequireDefault(__webpack_require__(230));
        var _interopRequireDefault = __webpack_require__(0);
        ...
        var MouseMoveInteraction =
            /*#__PURE__*/
            function(_base_interaction) {
                (0, _inherits2.default)(MouseMoveInteraction, _base_interaction);
    ...
    /* 227 */
     ...
     (function(module, exports, __webpack_require__) {
        ...
        var _scroll = _interopRequireDefault(__webpack_require__(229));

        var _mouseMove = _interopRequireDefault(__webpack_require__(226));

        var _actions = _interopRequireDefault(__webpack_require__(228));
        ...
        var _default =
            /*#__PURE__*/
            function(_elementorModulesVie) {
                
                (0, _inherits2.default)(_default, _elementorModulesVie);
        ...
        var _default =
            ...
            function(_elementorModules$Mod) {
                ...
                (0, _createClass2.default)(_default, [
                {
                    ...
                    key: "runAction",
                    value: function runAction(actionName, actionData, passedPercents, ...args) {
    ...
    (function(module, exports, __webpack_require__) {
        ...
        var _default =
            ...
            function(_base_interaction) {
                ...
                (0, _inherits2.default)(_default, _base_interaction);
        ...
        var _default =
            ...
            function(_elementorModulesVie) {
                ...
                (0, _createClass2.default)(_default, [
                    ...
                    key: "runCallback",
                    value: function runCallback(...args) {
    ...
    (function(module, exports, __webpack_require__) {
        ...
        var TextPath = elementorModules.frontend.handlers.Base.extend({
            getDefaultSettings: function getDefaultSettings() {
                return {
                    selectors: {
            ...
            attachIdToPath: function attachIdToPath(setting) {
            ...
            initTextPath: function initTextPath(setting) {
                const {
                    start_point: startPoint
                  } = this.getElementSettings();
            ...
            setText: function setText(newText) {
                ...
                if (url) {
                    newText = `<a href="${url}" rel="${rel}" target="${target}">${newText}</a>`;
                } // Set the text.
            ...
            shouldReverseText: function shouldReverseText(newText) {
                return this.isRTL() && -1 === navigator.userAgent.indexOf('Firefox');
            },
            reverseToRTL: function reverseToRTL(newText) {
        ...
        module.exports = function($scope) {
            elementorFrontend.elementsHandler.addHandler(TextPath, {
                $element: $scope
            });
        };
        /***/
    ...
    (function(module, exports, __webpack_require__) {
        ...
        var ShareButtons = elementorModules.frontend.handlers.Base.extend({
            getDefaultSettings: function getDefaultSettings() {
                return {
                    selectors: {
        ...
        module.exports = function($scope) {
            elementorFrontend.elementsHandler.addHandler(ShareButtons, {
                $element: $scope
            });
        };
        /***/
    ...
    (function(module, exports, __webpack_require__) {
        ...
        var QunatitySpinner = elementorModules.frontend.handlers.Base.extend({
            onInit: function onInit() {
                ...
                $("body").on("change keyup", "#quantity_wanted", function(t){
                    $(t.currentTarget).trigger("touchspin.stopspin");
        ...
        module.exports = function($scope) {
            elementorFrontend.elementsHandler.addHandler(QunatitySpinner, {
                $element: $scope
            });
        };
        /***/
    ...
    (function(module, exports, __webpack_require__) {
        ...
        var EventManager = __webpack_require__(218),
            ...
            MotionFxModule = _interopRequireDefault(__webpack_require__(224));
    ...
    (function(module, exports, __webpack_require__) {
        ...
        module.exports = function($) {
            ...
            var handlers = {
                ...
                'bestseller_products.default': __webpack_require__(481),
                'animated_headline.default': __webpack_require__(484),
                'text_path.default': __webpack_require__(231),
                'product_quantity.default': __webpack_require__(233),
                'share-buttons.default': __webpack_require__(232)
            };
            ...
            var addElementsHandlers = function addElementsHandlers() {
                ...
                elementorFrontend.hooks.addAction('frontend/element_ready/section' , __webpack_require__(482));
                elementorFrontend.hooks.addAction('frontend/element_ready/widget' , __webpack_require__(482));
    ...
    (function(module, exports, __webpack_require__) {
        ...
        // var _interopRequireDefault = __webpack_require__(0);
        // var MotionFxModule = _interopRequireDefault(__webpack_require__(225));
        ...
        module.exports = function($scope) {
            ...
            // elementorFrontend.elementsHandler.addHandler(MotionFxModule.default, {
            //     $element: $scope
            // });
            if (elementorFrontend.isEditMode()) {
    ...
    var _interopRequireDefault = __webpack_require__(0);
    var _scroll = _interopRequireDefault(__webpack_require__(483));
    
    var AnimatedHeadline = elementorModules.frontend.handlers.Base.extend({
      svgPaths: {
    ...
    module.exports = function($scope) {
        elementorFrontend.elementsHandler.addHandler(AnimatedHeadline, {
            $element: $scope
        });
    };
        /***/
