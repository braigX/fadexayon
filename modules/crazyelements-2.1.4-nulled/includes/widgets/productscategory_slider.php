...
class Widget_Productscategory_Slider extends Widget_Base {
	...
	public function get_name() {
		return 'productscategory_slider';
	}
	...
	public function get_title() {
		return PrestaHelper::__( 'Products Category Slider', 'elementor' );
	}
	...
	protected function _register_controls() {
		...
		$control = array(
			...
			array(
				...
				'item_type' => 'category',
				'multiple'  => false,
				'description' => PrestaHelper::__( 'Not Selecting Any Category Will Show Random Products', 'elementor' ),
				'separator' => 'before'
			)
		);

		$this->general_controls($control, true, 'random_query', false, false);
	...
	protected function render() {
		...
		// where query params
		$id_category =  $this->render_autocomplete_result($ids);
		$cache_products = $this->products_by_category($id_lang, $id_category, $orderby, $order, $limit, $random_query);
		...
		$this->current_context->smarty->assign(
			array(
				...
				'elementprefix'       => 'products-category-slider',
