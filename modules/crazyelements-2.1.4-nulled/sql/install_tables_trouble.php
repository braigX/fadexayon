...
$sql[_DB_PREFIX_ . 'crazy_options'][] = 'CREATE TABLE IF NOT EXISTS `' . _DB_PREFIX_ . "crazy_options` (
...
$sql[_DB_PREFIX_ . 'crazy_options'][] = 'ALTER TABLE `' . _DB_PREFIX_ . 'crazy_options`
...
$sql[_DB_PREFIX_ .'crazy_library'][] = 'CREATE TABLE IF NOT EXISTS `' . _DB_PREFIX_ . 'crazy_library` (
...
$sql[_DB_PREFIX_ .'crazy_library'][] = 'ALTER TABLE `' . _DB_PREFIX_ . 'crazy_library`
ADD PRIMARY KEY (`id_crazy_library`);';
$sql[_DB_PREFIX_ .'crazy_library'][] = 'ALTER TABLE `' . _DB_PREFIX_ . 'crazy_library`
MODIFY `id_crazy_library` int(100) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=1;';

$sql[_DB_PREFIX_ .'crazy_content_shop'][] = 'CREATE TABLE IF NOT EXISTS `' . _DB_PREFIX_ . 'crazy_content_shop` ( 
    `id_crazy_content` int(11) NOT NULL,
    `id_shop` int(11) NOT NULL
  ) ENGINE=InnoDB DEFAULT CHARSET=latin1;';

$sql[_DB_PREFIX_ .'crazy_content_shop'][] = 'ALTER TABLE `' . _DB_PREFIX_ . 'crazy_content_shop`
ADD UNIQUE KEY `id_crazy_content` (`id_crazy_content`,`id_shop`);';
  // ------------------------------------------------------------------------
$sql[_DB_PREFIX_ .'crazy_content_lang'][] = 'CREATE TABLE IF NOT EXISTS `' . _DB_PREFIX_ . 'crazy_content_lang` (
    `id_crazy_content` int(11) NOT NULL,
...
$sql[_DB_PREFIX_ .'crazy_content_lang'][] = 'ALTER TABLE `' . _DB_PREFIX_ . 'crazy_content_lang`
ADD UNIQUE KEY `id_crazy_content` (`id_crazy_content`,`id_lang`);';
// ------------------------------------------------------------------------
$sql[_DB_PREFIX_ .'crazy_content'][] = 'CREATE TABLE IF NOT EXISTS `' . _DB_PREFIX_ . 'crazy_content` (
    `id_crazy_content` int(11) NOT NULL,
...
$sql[_DB_PREFIX_ .'crazy_content'][] = 'ALTER TABLE `' . _DB_PREFIX_ . 'crazy_content`
...
// Canvas_issue
$sql[_DB_PREFIX_ .'crazy_layout_type'][] = 'CREATE TABLE IF NOT EXISTS `' . _DB_PREFIX_ . 'crazy_layout_type` (
  `id_layout_type` int(11) NOT NULL,
  `id_content_type` int(11) NOT NULL,
  `hook` varchar(100) NOT NULL,
  `crazy_page_layout` varchar(100) NOT NULL
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=latin1;';
$sql[_DB_PREFIX_ .'crazy_layout_type'][] = 'ALTER TABLE `' . _DB_PREFIX_ . 'crazy_layout_type`
ADD PRIMARY KEY (`id_layout_type`);';
$sql[_DB_PREFIX_ .'crazy_layout_type'][] = 'ALTER TABLE `' . _DB_PREFIX_ . 'crazy_layout_type`
MODIFY `id_layout_type` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=1;';


$sql[_DB_PREFIX_ .'crazy_setting'][] = 'CREATE TABLE IF NOT EXISTS `' . _DB_PREFIX_ . 'crazy_setting` (
...
$sql[_DB_PREFIX_ .'crazy_setting'][] = 'ALTER TABLE `' . _DB_PREFIX_ . 'crazy_setting`
ADD PRIMARY KEY (`ps_crazy_id`)';

$sql[_DB_PREFIX_ .'crazy_setting'][] = 'ALTER TABLE `' . _DB_PREFIX_ . 'crazy_setting`
MODIFY `ps_crazy_id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1;';

$sql[_DB_PREFIX_ .'crazy_revision'][] = 'CREATE TABLE  ' . _DB_PREFIX_ . 'crazy_revision (
...
$sql[_DB_PREFIX_ .'crazy_fonts'][] = 'CREATE TABLE  ' . _DB_PREFIX_ . 'crazy_fonts (
...
$sql[_DB_PREFIX_ .'crazy_autocomplete_products'][] = 'CREATE TABLE IF NOT EXISTS `' . _DB_PREFIX_ . 'crazy_autocomplete_products`(
...
$sql[_DB_PREFIX_ .'crazy_extended_modules'][] = 'CREATE TABLE IF NOT EXISTS `' . _DB_PREFIX_ . 'crazy_extended_modules` (
...
$sql[_DB_PREFIX_ .'crazy_extended_modules'][] = 'ALTER TABLE `' . _DB_PREFIX_ . 'crazy_extended_modules`
...
$sql[_DB_PREFIX_ .'crazyprdlayouts'][] = 'CREATE TABLE IF NOT EXISTS `' . _DB_PREFIX_ . 'crazyprdlayouts`(
...
$sql[_DB_PREFIX_ .'crazyprdlayouts_lang'][] = 'CREATE TABLE IF NOT EXISTS `' . _DB_PREFIX_ . 'crazyprdlayouts_lang` (
...
$sql[_DB_PREFIX_ .'crazyprdlayouts_shop'][] = 'CREATE TABLE IF NOT EXISTS `' . _DB_PREFIX_ . 'crazyprdlayouts_shop` (
