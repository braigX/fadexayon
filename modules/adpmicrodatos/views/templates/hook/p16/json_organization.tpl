...
{literal}
<script type="application/ld+json" id="adpmicrodatos-organization-ps16v{/literal}{$module_version}{literal}">
{
	...
	{/literal}{if $page_name =='index'}{literal}
		"description": {/literal}{$meta_description|@json_encode nofilter}{literal},
	{/literal}{/if}{literal}
