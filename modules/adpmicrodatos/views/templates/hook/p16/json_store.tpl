...
{literal}
<script type="application/ld+json" id="adpmicrodatos-store-ps16v{/literal}{$module_version}{literal}">
{
    ...
    "address": {
            ...
            "postalCode": {/literal}{$tienda.postcode|@json_encode nofilter}{literal},
