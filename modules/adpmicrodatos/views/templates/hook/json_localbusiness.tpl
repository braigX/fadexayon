...
{literal}
<script type="application/ld+json" id="adpmicrodatos-localbusiness-ps17v{/literal}{$module_version|escape:'htmlall':'UTF-8'}{literal}">
{
    ...
    "geo": {
        "@type": "GeoCoordinates",
        "latitude": {/literal}{$latitude|@json_encode nofilter}{literal},
        "longitude": {/literal}{$longitude|@json_encode nofilter}{literal}
    },
    {/literal}{/if}{literal}
    "priceRange": "{/literal}{$min_price} - {$max_price}{literal}",
