...
{literal}
<script type="application/ld+json" id="adpmicrodatos-organization-ps17v{/literal}{$module_version|escape:'htmlall':'UTF-8'}{literal}">
{
    "name" : {/literal}{$shop.name|@json_encode nofilter}{literal},
    "url" : {/literal}{$urls.base_url|@json_encode nofilter}{literal},
    "logo" : [
    	{
    ...
    {/literal}{if !empty($email_comercio)}{literal}
	...
	{/literal}{/if}{literal}
	{/literal}{if !empty($addressLocality)}{literal}
	"address": {
	    "@type": "PostalAddress",
	...
	{/literal}{/if}{literal}
	{/literal}{if !empty($telefono_comercio)}{literal}
	"contactPoint" : [
		{
			"@type" : "ContactPoint",
	    	"telephone" : {/literal}{$telefono_comercio|@json_encode nofilter}{literal},
	    	...
	    	"availableLanguage": [ 
	    		{/literal}{foreach key=key from=$nombre_idiomas_disponibles item=nombre_idioma_disponible}{literal}
	    			{/literal}{if $key > 0}{literal}
	    				,{/literal}{$nombre_idioma_disponible|@json_encode nofilter}{literal}
