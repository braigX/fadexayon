...
{if !empty($producto_relacionado.id_product)}
            "productID": {$producto_relacionado.id_product|@json_encode nofilter},
{/if}
...
{if !empty($producto_relacionado.imagenes)}
            "image": {$producto_relacionado.imagenes|@json_encode nofilter},
{/if}
{if !empty($producto_relacionado.url)}
            "url": {$producto_relacionado.url|@json_encode nofilter},
{/if}
{if !empty($set_configuration_product_gtin)}
    ...
    {else if $set_configuration_product_gtin == 2}
        "gtin13": {$producto_relacionado.upc|@json_encode nofilter},
    {else}
        "gtin13": {$producto_relacionado.isbn|@json_encode nofilter},
    {/if}
{/if}
