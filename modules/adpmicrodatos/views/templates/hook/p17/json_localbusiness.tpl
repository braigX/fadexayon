...
{if $page_name == 'index'}
{literal}
<script type="application/ld+json" id="adpmicrodatos-localbusiness-ps17v{/literal}{$module_version}{literal}">
{
    ...
    "geo": {
        "@type": "GeoCoordinates",
        "latitude": "{/literal}{$latitude}{literal}",
        "longitude": "{/literal}{$longitude}{literal}"
    },
    {/literal}{/if}{literal}
