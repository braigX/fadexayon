...
{if $is_microdata_organization == '1'}
<!-- Microdatos Organization --->
	{include file="./json_organization.tpl"}
{/if}

{if $is_microdata_localbusiness == '1'}
...
{if $page.page_name =='index' && $active_microdata_website == '1'}
<!-- Microdatos Website -->
...
<!-- Microdatos Producto -->
	{if $set_microdata_type_combinations_product == '1'}
		{include file="./json_product.tpl"}
	{else}
		{include file="./json_product_group.tpl"}
	{/if}
{/if}
