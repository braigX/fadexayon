...
<div id="log-block">
	{foreach from=$log item=logline}
		<!--{$logline|escape:'htmlall':'UTF-8'}--><br>
	{/foreach}
</div>
<div id="clear-log">
	<input type="button" name="clear-log" class="clear-log btn btn-default btn-block" value="{l s='Clear Log' mod='productsindex'}"/>
</div>