...
class smartbloghomelatestnews extends Module
{
    ...
    public function install()
    {
        ...
        Configuration::updateValue('smartcustomcsslatest', "");
    ...
    public function smartbloghomelatestnewsHookDisplayHome($params)
    {
        ...
        if (!$this->isCached('smartblog_latest_news.tpl')) {
            ...
            $this->smarty->assign(array(
                ...
                'smartcustomcsslatest' => Configuration::get('smartcustomcsslatest')
            ));
        }
    ...
    public function hookDisplayTopColumn($params)
    {
        if (Module::isInstalled(trim('smartblog'))) {
            ...
            if (!Module::isEnabled(trim('smartblog'))) {
                return '<strong>' . $this->displayName . "</strong> is a child module of SmartBlog. Please enable SmartBlog to use it.";
            }
        } else {
            return '<strong>' . $this->displayName . "</strong> is a child module of SmartBlog. Please install SmartBlog to use it.";
        }
    ...
    public function getContent()
    {
        ...
        if (Tools::isSubmit('save' . $this->name)) {
            ...
            Configuration::updateValue('smartcustomcsslatest', Tools::getvalue('smartcustomcsslatest'));
    ...
    public function SettingForm()
    {
        ...
        $helper->fields_value['smartcustomcsslatest'] = Configuration::get('smartcustomcsslatest');
        return $helper;
    }
}