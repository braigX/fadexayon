...
<script type="text/javascript">
    ...
    var ets_mm_invalid_file = "{l s='File is invalid' mod='ets_megamenu'}";
    var ets_mm_invalid_image = "{l s='Image is invalid' mod='ets_megamenu'}";
    var mmLabelDelete = "{l s='Delete' mod='ets_megamenu'}";
    var Saved_text ='{l s='Saved' mod='ets_megamenu' js=1}';
    var confirm_delete_menu ='{l s='Do you want to delete this menu?' mod='ets_megamenu' js=1}';
    var confirm_delete_tab ='{l s='Do you want to delete this tab?' mod='ets_megamenu' js=1}';
    var confirm_delete_column ='{l s='Do you want to delete this column?' mod='ets_megamenu' js=1}';
    var confirm_delete_block ='{l s='Do you want to delete this block?' mod='ets_megamenu' js=1}';
</script>
