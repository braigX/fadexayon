...
<div id="tag-generator-panel-date" class="hidden">
    <form action="" class="tag-generator-panel" data-id="date"><div class="control-box">
        <fieldset>
        <legend>{l s='Generate a form-tag for a date input field. For more details, see' mod='ets_contactform7'} <a href="{$link_doc|escape:'html':'UTF-8'}#date-field" target="_blank">{l s='Date Field' mod='ets_contactform7'}</a>.</legend>
        ...
        <tbody>
            ...
            <label class="cursor_pointer"><input type="checkbox" name="time" class="option" />{l s='Allow customer select time "hour and minute"' mod='ets_contactform7'}</label>
            </td>
        	</tr>
        	<tr>
