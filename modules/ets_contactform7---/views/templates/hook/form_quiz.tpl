...
<label>
    <span class="wpcf7-quiz-label">{$question|escape:'html':'UTF-8'}</span>
    <input 
        {if $atts}
        ...
        {/if}
     />
</label><input type="hidden" name="_etscf7_quiz_answer_{$tag_name|escape:'html':'UTF-8'}" value="{$answer|escape:'html':'UTF-8'}" />
