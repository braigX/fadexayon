...
{if isset($products) && $products}
    {foreach from=$products item='product'}
        <li class="ets_ode_item " data-id="{$product.id_product|intval}-{$product.id_product_attribute|intval}">
            <a class="product_img_link" href="{$product.link|escape:'html':'UTF-8'}" title="{$product.name|escape:'html':'UTF-8'}" itemprop="url">
                <img class="ets_ode_product_image" src="{$product.image|escape:'quotes':'UTF-8'}" alt="{$product.name|truncate:20:'...':true|escape:'html':'UTF-8'}"/>
                <div class="ets_ode_product_info">
            ...
            <div class="ets_ode_block_item_close" title="{l s='Delete' mod='ets_ordermanager'}">
