              ...
              <div class="table-responsive">
                <table class="table" id="orderProducts">
                  ...
                  {foreach from=$products item=product key=k}
                    {include file='$tpl_dir/../../override/controllers/admin/templates/orders/_customized_data.tpl'}
                    {include file="$tpl_dir/../../override/controllers/admin/templates/orders/_product_line.tpl"}
                  {/foreach}
                  </tbody>
                </table>
              </div>
